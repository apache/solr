...
local environmentVar =
  ...
  + v.query.generalOptions.withIncludeAll(value=true, customAllValue='.*')
...
local solrcloudRow =
  ...
  + {
    ...
    panels: [
      ts('Overseer Collection Work Queue',
        [prom(
      ...
      ts('Overseer State Update Queue',
        [prom(
      ...
      statPanel('Shard Leaders on Node',
        [prom(
      ...
      statPanel('Update Log Replay Remaining',
        [prom(
...
local indexHealthRow =
  ...
  + {
    ...
    panels: [
      barPanel('Segment Count per Core',
        [prom(
...
local cacheRow =
  ...
  + {
    ...
    panels: [
      ...
      ts('Query Result Cache Hit Rate',
        [prom(
      ...
      ts('Query Result Cache Evictions',
        [prom(
