...
public class BlockSolrServerTillFinishTask extends PerfTask {
  ...
  public int doLogic() throws Exception {
    ...
    if (solrServer instanceof ConcurrentUpdateHttp2SolrClient) {
      ((ConcurrentUpdateHttp2SolrClient)solrServer).blockUntilFinished();
    }
//    if (solrServer instanceof Http2SolrClient) {
//      ((Http2SolrClient)solrServer).waitForOutstandingRequests();
//    }
