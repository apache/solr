...
public class RangeFieldSearch {
  ...
  public static class BenchState {
    ...
    public void setupTrial(MiniClusterState.MiniClusterBenchState miniClusterState)
      ...
      miniClusterState.index(COLLECTION, docs, NUM_DOCS, false);

      // Discover the real term values (and their counts) so queries hit existing terms.
      String basePath = miniClusterState.nodes.get(0);
      ...
      QueryResponse response =
          new QueryRequest(q).processWithBaseUrl(miniClusterState.client, basePath, COLLECTION);
      ...
      long rangeCost =
          new QueryRequest(rangeOnly)
              .processWithBaseUrl(miniClusterState.client, basePath, COLLECTION)
              .getResults()
              .getNumFound();
  ...
  public void rangeQuery(
    ...
    blackhole.consume(benchState.query().process(miniClusterState.client, COLLECTION));
  }
}
