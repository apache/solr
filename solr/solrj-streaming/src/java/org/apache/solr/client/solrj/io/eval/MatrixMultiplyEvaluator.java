...
public class MatrixMultiplyEvaluator extends RecursiveObjectEvaluator implements TwoValueWorker {
  ...
  public MatrixMultiplyEvaluator(StreamExpression expression, StreamFactory factory)
      throws IOException {
  ...
  private Array2DRowRealMatrix getMatrix(Object o) throws IOException {
    if (o instanceof Matrix matrix) {
      ...
      throw new IOException(
          "The matrixMult function can only be applied to numeric arrays and matrices:"
              + o.getClass().toString());
    }
  }
}
