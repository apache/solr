...
public class GeometricDistributionEvaluator extends RecursiveNumericEvaluator
    implements OneValueWorker {

  private static final long serialVersionUID = 1;

  public GeometricDistributionEvaluator(StreamExpression expression, StreamFactory factory)
      throws IOException {
