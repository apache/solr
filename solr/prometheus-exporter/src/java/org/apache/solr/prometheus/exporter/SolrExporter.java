...
public class SolrExporter {
  ...
  private static final String ARG_SSL_DEFAULT = "false";
  private static final String ARG_SSL_HELP =
      "Enable tls to Solr. Expects following env varables: SOLR_SSL_KEY_STORE, SOLR_SSL_KEY_STORE_PASSWORD, SOLR_SSL_TRUST_STORE, SOLR_SSL_TRUST_STORE_PASSWORD. Example: --ssl-enabled true";
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      if ("true".equals(res.getString(ARG_SSL_DEST))) {
