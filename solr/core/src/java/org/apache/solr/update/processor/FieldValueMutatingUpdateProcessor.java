...
public abstract class FieldValueMutatingUpdateProcessor extends FieldMutatingUpdateProcessor {
  ...
  public FieldValueMutatingUpdateProcessor(
   ...
   *     indicate that the value should be removed completely.
  ...
  @Override
  @SuppressWarnings(
      "ReferenceEquality") // DELETE_VALUE_SINGLETON is a unique sentinel; identity check is
  // intentional
  ...
  public static FieldValueMutatingUpdateProcessor valueMutator(
      FieldNameSelector selector, UpdateRequestProcessor next, Function<Object, Object> fun) {
