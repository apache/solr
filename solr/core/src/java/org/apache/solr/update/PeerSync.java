...
public class PeerSync implements SolrMetricProducer {
  ...
  private final UpdateHandler uhandler;
  private final UpdateLog ulog;
  private final ShardHandler shardHandler;
  private final List<SyncShardRequest> requests = new ArrayList<>();
  ...
  // is in the chain
  private static boolean connectTimeoutExceptionInChain(Throwable exception) {
  ...
  static abstract class MissedUpdatesFinderBase {
    private final Set<Long> ourUpdateSet;
    private final Set<Long> requestedUpdateSet = new HashSet<>();
    ...
    private static boolean sorted(List<Long> list) {
    ...
    static MissedUpdatesRequest handleVersionsWithRanges(List<Long> ourUpdates, List<Long> otherVersions, boolean completeList, long ourLowThreshold) {
      ...
      String rangesToRequestStr = String.join(",", rangesToRequest);
