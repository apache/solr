...
public class DocsStreamer implements Iterator<SolrDocument> {
  ...
  static {
    ...
    KNOWN_TYPES.add(DenseVectorField.class); // DenseVectorField extends FloatPointField but here we list DenseVectorField explicitly due to KNOWN_TYPES.contains use of the KNOWN_TYPES set
