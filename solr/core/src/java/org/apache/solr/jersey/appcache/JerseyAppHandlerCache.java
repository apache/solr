...
// TODO If I can't find an off-the-shelf replacement of this, revisit thread safety on refcount modification
public class JerseyAppHandlerCache {
    ...
    public RefCounted<ApplicationHandler> computeIfAbsent(String effectiveConfigSetId, Supplier<ApplicationHandler> createApplicationHandler) {
        final Function<String, RefCounted<ApplicationHandler>> wrapper = s -> {
        ...
        final RefCounted<ApplicationHandler> fetched = applicationByConfigSetId.computeIfAbsent(effectiveConfigSetId, wrapper);
        fetched.incref();
        return fetched;
    }
