...
public class Assign {
  ...
  public static ReplicaName buildSolrCoreName(DocCollection collection, String shard, Replica.Type type, Overseer overseer) {
    ...
    int cnt = overseer.getZkStateWriter().getReplicaAssignCnt(collection.getName(), shard, namePrefix);
  ...
  public static class AssignStrategyFactory {
    ...
    public static AssignStrategy create() throws IOException, InterruptedException {
