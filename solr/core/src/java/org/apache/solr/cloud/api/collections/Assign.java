...
import org.apache.solr.cluster.placement.plugins.DefaultPlacementFactory;
...
public class Assign {
   ...
   * configured.
   * <p>If {@link PlacementPlugin} instance is null this call will return {@link DefaultPlacementFactory.DefaultPlacementPlugin}, otherwise
