...
class NullCountSlotAcc extends SlotAcc.CountSlotAcc {
   ...
   */
  static final CountSlotAcc DEV_NULL_SLOT_ACC = new NullCountSlotAcc();

  public NullCountSlotAcc() {
    super(null);
  }
  ...
  @Override public void collect(int doc, int slot, IntFunction<SlotContext> slotContext) throws IOException {
    // No-op
  }

  @Override public void incrementCount(int slot, long count) {
    // No-op
  }

  @Override public void setNextReader(LeafReaderContext readerContext) throws IOException {
    // No-op
  }

  @Override public int collect(DocSet docs, int slot, IntFunction<SlotContext> slotContext) throws IOException {
  ...
  @Override public long getCount(int slot) {
    throw new UnsupportedOperationException("not supported");
  }
}
