 ...
 * </ul>
 *
 * The distance measure used currently depends on the FieldType. {@link LatLonPointSpatialField}
 * defaults to using haversine, {@link PointType} defaults to Euclidean (2-norm).
 *
 * <p>Examples:
 *
 ...
 * <pre>fq={!geofilt}&amp;sfield=store&amp;pt=10.312,-20&amp;d=3.5</pre>
 *
 * <p>Note: The geofilt for {@link LatLonPointSpatialField} is capable of also producing scores
