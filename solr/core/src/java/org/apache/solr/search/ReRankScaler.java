...
public class ReRankScaler {
  ...
  public ReRankScaler(String mainRange, String reRankRange, ReRankOperator reRankOperator) throws SyntaxError {
  ...
  public ScoreDoc[] scaleScores(ScoreDoc[] originalDocs,
  ...
  public static float getReRankScore(float originalScore, float combinedScore, ReRankOperator reRankOperator) {
