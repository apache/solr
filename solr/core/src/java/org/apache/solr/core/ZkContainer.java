    ...
    if (zookeeperHost != null) {
      ...
      try {
        ...
        if(confDir != null) {
          ...
          ZkMaintenanceUtils.uploadToZK(zkController.getZkClient(), configPath, ZkMaintenanceUtils.CONFIGS_ZKNODE + "/" + confName, ZkMaintenanceUtils.UPLOAD_FILENAME_EXCLUDE_PATTERN);
        }
