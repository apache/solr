...
public abstract class TracerConfigurator implements NamedListInitializedPlugin {
  ...
  //   * possibly exposing a Span to a thread that may find that it has already finished, depending
  // on
  //   * how the instrumented thread pool is used. It's probably fine to create new spans related to
  // a
