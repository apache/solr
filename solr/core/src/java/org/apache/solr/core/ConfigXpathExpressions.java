...
public class ConfigXpathExpressions {

  private static final Logger log = LoggerFactory.getLogger(MethodHandles.lookup().lookupClass());

  public final static Map<String,XPathExpression> CACHE = new ConcurrentHashMap<>(64);
  ...
  public static String  queryCacheConfigsPath = "/config/query/cache";
  ...
  public XPathExpression queryCacheConfigsExp;
  ...
  public ConfigXpathExpressions(XPathFactoryImpl xpathFactory) {
    ...
    try {
      ...
      try {
        queryCacheConfigsExp = xpath.compile(queryCacheConfigsPath);
      } catch (XPathExpressionException e) {
        log.error("", e);
      }
      ...
      String path = "/config/indexConfig/mergePolicyFactory";
      addToCache(xpath, path);

      String path2 = "/config/indexConfig/mergeScheduler";
      addToCache(xpath, path2);

      String path3 = "/config/indexConfig/metrics";
      addToCache(xpath, path3);

      addToCache(xpath, "/config/expressible");
      addToCache(xpath, "/config/queryResponseWriter");
      addToCache(xpath, "/config/valueSourceParser");
      addToCache(xpath, "/config/transformer");
      addToCache(xpath, "/config/searchComponent");
      addToCache(xpath, "/config/updateProcessor");
      addToCache(xpath, "/config/cache");
      addToCache(xpath, "/config/queryConverter");
      addToCache(xpath, "/config/initParams");
      addToCache(xpath, "//listener");
      addToCache(xpath, "/config/directoryFactory");
      addToCache(xpath, "/config/recoveryStrategy");
      addToCache(xpath, "/config/indexConfig/mergePolicy");
      addToCache(xpath, "/config/indexConfig/mergedSegmentWarmer");


      addToCache(xpath, "/config/restManager");
      addToCache(xpath, "/config/statsCache");
      addToCache(xpath, "/config/queryParser");
      addToCache(xpath, "/config/indexConfig/deletionPolicy");
      addToCache(xpath, "/config/codecFactory");
      addToCache(xpath, "/config/updateHandler/updateLog");
      addToCache(xpath, "/config/updateRequestProcessorChain");
      addToCache(xpath, "/config/schemaFactory");
      addToCache(xpath, "/config/lib");

      addToCache(xpath, "/config/requestHandler");
      addToCache(xpath, "/config/indexReaderFactory");
      addToCache(xpath, "/config/propTest");


      addToCache(xpath, "solr/backup/repository");
      addToCache(xpath, "solr/metrics/hiddenSysProps/str");
      addToCache(xpath, "solr");
  ...
  private static void addToCache(XPath xpath, String path) throws XPathExpressionException {
    CACHE.put(path, xpath.compile(path));
  }
}
