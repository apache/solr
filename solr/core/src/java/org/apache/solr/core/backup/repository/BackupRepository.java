...
public interface BackupRepository extends NamedListInitializedPlugin, Closeable {
  ...
  /**
   * This method returns the directory URI representation for the specified path. Note - the
   * specified path could be a fully qualified URI OR a relative path for a file-system.
   *
   * @param path The path specified by the user.
  ...
  // 'mkdir', or 'mkdir -p')
  /**
   * This method creates a directory at the specified path. If the directory already exist, this
   * will be a no-op.
   *
