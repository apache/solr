...
/**
 * <b>Expert:</b> This class provides a {@link TokenStream} for indexing numeric values that can be
 * used by {@link org.apache.solr.legacy.LegacyNumericRangeQuery}.
 *
 * <p>Note that for simple usage, {@link org.apache.solr.legacy.LegacyIntField}, {@link
 * org.apache.solr.legacy.LegacyLongField}, {@link org.apache.solr.legacy.LegacyFloatField} or
 * {@link org.apache.solr.legacy.LegacyDoubleField} is recommended. These fields disable norms and
 ...
 * </pre>
 *
 * <p>For optimal performance, re-use the TokenStream and Field instance for more than one document:
 *
 * <pre class="prettyprint">
 ...
 * </pre>
 *
 * <p>This stream is not intended to be used in analyzers; it's more for iterating the different
 * precisions during indexing a specific numeric value.
 *
 * <p><b>NOTE</b>: as token streams are only consumed once the document is added to the index, if
 * you index more than one numeric field, use a separate <code>LegacyNumericTokenStream</code>
 * instance for each.
 *
 * <p>See {@link org.apache.solr.legacy.LegacyNumericRangeQuery} for more details on the <a
 * href="LegacyNumericRangeQuery.html#precisionStepDesc"><code>precisionStep</code></a> parameter as
...
public final class LegacyNumericTokenStream extends TokenStream {
    ...
    public AttributeImpl createAttributeInstance(Class<? extends Attribute> attClass) {
      if (CharTermAttribute.class.isAssignableFrom(attClass))
        throw new IllegalArgumentException(
            "LegacyNumericTokenStream does not support CharTermAttribute.");
  ...
  /**
   * Creates a token stream for numeric values using the default <code>precisionStep</code> {@link
   * org.apache.solr.legacy.LegacyNumericUtils#PRECISION_STEP_DEFAULT} (16). The stream is not yet
  ...
  /**
   * Creates a token stream for numeric values with the specified <code>precisionStep</code>. The
   * stream is not yet initialized, before using set a value using the various
   * set<em>???</em>Value() methods.
   */
  ...
  /**
   * Expert: Creates a token stream for numeric values with the specified <code>precisionStep</code>
   * using the given {@link org.apache.lucene.util.AttributeFactory}. The stream is not yet
   * initialized, before using set a value using the various set<em>???</em>Value() methods.
   */
   ...
   *     new Field(name, new LegacyNumericTokenStream(precisionStep).setLongValue(value))</code>
   */
   ...
   * @param value the value, for which this TokenStream should enumerate tokens.
   * @return this instance, because of this you can use it the following way: <code>
   *     new Field(name, new LegacyNumericTokenStream(precisionStep).setIntValue(value))</code>
   */
   ...
   * @param value the value, for which this TokenStream should enumerate tokens.
   * @return this instance, because of this you can use it the following way: <code>
   *     new Field(name, new LegacyNumericTokenStream(precisionStep).setDoubleValue(value))</code>
   */
   ...
   * @param value the value, for which this TokenStream should enumerate tokens.
   * @return this instance, because of this you can use it the following way: <code>
   *     new Field(name, new LegacyNumericTokenStream(precisionStep).setFloatValue(value))</code>
   */
  ...
  private final LegacyNumericTermAttribute numericAtt =
      addAttribute(LegacyNumericTermAttribute.class);
