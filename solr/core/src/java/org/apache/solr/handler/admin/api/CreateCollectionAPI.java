...
public class CreateCollectionAPI extends AdminAPIBase {
    ...
    public static void validateRequestBody(CreateCollectionRequestBody reqBody) {
        if (reqBody.replicationFactor != null && reqBody.nrtReplicas != null && reqBody.replicationFactor != reqBody.nrtReplicas) {
    ...
    public static ZkNodeProps createRemoteMessage(CoreContainer coreContainer, CreateCollectionRequestBody reqBody) throws IOException {
        ...
        // 'nrtReplicas' and 'replicationFactor' are both set on the remote message, despite being functionally equivalent.
        ...
        if (reqBody.nrtReplicas != null) {
            ...
            if (reqBody.replicationFactor == null) rawProperties.put(REPLICATION_FACTOR, reqBody.nrtReplicas);
        }

        // TODO Separate this out so it happens prior to message creation?  Might make it easier to test...
    ...
    public static CreateCollectionRequestBody buildRequestBodyFromParams(SolrParams params) {
        final CreateCollectionAPI.CreateCollectionRequestBody requestBody = new CreateCollectionAPI.CreateCollectionRequestBody();
        ...
        if (params.get("router.name") != null || params.get("router.field") != null) {
            final CreateCollectionAPI.RouterProperties routerProperties = new CreateCollectionAPI.RouterProperties();
    ...
    private static void copyFromClusterProp(CoreContainer coreContainer, Map<String, Object> props, String prop) throws IOException {
