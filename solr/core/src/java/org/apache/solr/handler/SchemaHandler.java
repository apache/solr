...
public class SchemaHandler extends RequestHandlerBase
        ...
        case "/schema":
          {
            V2ApiUtils.squashIntoSolrResponseWithoutHeader(
                rsp,
                new GetSchemaAPI(req.getCore(), req.getCore().getLatestSchema()).getSchemaInfo());
            break;
          }
        case "/schema/version":
          {
            V2ApiUtils.squashIntoSolrResponseWithoutHeader(
                rsp,
                new GetSchemaAPI(req.getCore(), req.getCore().getLatestSchema())
                    .getSchemaVersion());
            break;
          }
        ...
        case "/schema/name":
          {
            V2ApiUtils.squashIntoSolrResponseWithoutHeader(
                rsp,
                new GetSchemaAPI(req.getCore(), req.getCore().getLatestSchema()).getSchemaName());
            break;
          }
  ...
  public Collection<Class<? extends JerseyResource>> getJerseyResources() {
    return List.of(GetSchemaAPI.class, GetSchemaFieldAPI.class);
  }
