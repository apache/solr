...
import org.apache.solr.client.api.endpoint.CoreReplicationApi;
 ...
 */
public class CoreReplication extends ReplicationAPIBase implements CoreReplicationApi {
  ...
  public SolrJerseyResponse fetchIndexVersion(String coreName) throws IOException {
    return doFetchIndexVersion();
  }

  @Override
  @PermissionName(CORE_READ_PERM)
  public SolrJerseyResponse fetchFileList(String coreName, long gen) {
