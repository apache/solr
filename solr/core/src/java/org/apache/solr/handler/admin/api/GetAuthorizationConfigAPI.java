 ...
 *
 * <p>This API (GET /v2/cluster/security/authorization) is analogous to the v1 `GET /solr/admin/authorization` API.
 */
public class GetAuthorizationConfigAPI {
    ...
    public void fetchAuthorizationConfig(SolrQueryRequest req, SolrQueryResponse rsp) throws Exception {
