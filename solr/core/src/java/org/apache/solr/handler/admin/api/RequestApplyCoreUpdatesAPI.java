 ...
 *
 * <p>Only valid in SolrCloud mode. This API (POST /v2/cores/coreName {'request-apply-updates': {}})
 * is analogous to the v1 /admin/cores?action=REQUESTAPPLYUPDATES command.
 *
