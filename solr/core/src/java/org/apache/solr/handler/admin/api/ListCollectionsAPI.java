...
public class ListCollectionsAPI extends AdminAPIBase {
    ...
    @Inject
    public ListCollectionsAPI(CoreContainer coreContainer, SolrQueryRequest req, SolrQueryResponse rsp) {
    ...
    public ListCollectionsResponse listCollections() {
        final ListCollectionsResponse response = instantiateJerseyResponse(ListCollectionsResponse.class);
