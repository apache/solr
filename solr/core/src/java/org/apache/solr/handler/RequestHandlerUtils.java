...
public class RequestHandlerUtils
{
  ...
  private static Set<String> commitParams = new HashSet<>(Arrays.asList(UpdateParams.OPEN_SEARCHER, UpdateParams.WAIT_SEARCHER, UpdateParams.SOFT_COMMIT,
      UpdateParams.EXPUNGE_DELETES, UpdateParams.MAX_OPTIMIZE_SEGMENTS, UpdateParams.PREPARE_COMMIT));
