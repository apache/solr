...
import org.apache.solr.common.VirtualExecutorService;
...
public class SolrExecutorCompletionService<V> implements CompletionService<V> {
  ...
  public SolrExecutorCompletionService(VirtualExecutorService executor) {
    if (executor == null) {
  ...
  public SolrExecutorCompletionService(VirtualExecutorService executor, BlockingQueue<Future<V>> completionQueue) {
