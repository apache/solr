...
public class TestFuzzyAnalyzedSuggestions extends SolrTestCaseJ4 {
  ...
  public static void beforeClass() throws Exception {
    ...
    assertQ(reqWithPath(URI_MIN_EDIT_2, "q", "", SpellingParams.SPELLCHECK_BUILD, "true"));
    assertQ(reqWithPath(URI_NON_PREFIX_LENGTH_4, "q", "", SpellingParams.SPELLCHECK_BUILD, "true"));
    assertQ(reqWithPath(URI_MIN_FUZZY_LENGTH, "q", "", SpellingParams.SPELLCHECK_BUILD, "true"));
  }
  ...
  public void testDefault() {
    ...
    assertQ(
        reqWithPath(URI_DEFAULT, "q", "chagn", SpellingParams.SPELLCHECK_COUNT, "3"),
    ...
    assertQ(
        reqWithPath(URI_DEFAULT, "q", "chacn", SpellingParams.SPELLCHECK_COUNT, "3"),
    ...
    assertQ(
        reqWithPath(URI_DEFAULT, "q", "chagr", SpellingParams.SPELLCHECK_COUNT, "3"),
    ...
    // test to demonstrate default nonFuzzyPrefix parameter (value: 1), control for
    // testWithNonFuzzyPrefix4
    assertQ(
        reqWithPath(URI_DEFAULT, "q", "chanr", SpellingParams.SPELLCHECK_COUNT, "3"),
        "//lst[@name='spellcheck']/lst[@name='suggestions']/lst[@name='chanr']/int[@name='numFound'][.='3']");

    // test to demonstrate default minFuzzyPrefix parameter (value: 3), control for
    // testWithMinFuzzyLength2
    assertQ(
        reqWithPath(URI_DEFAULT, "q", "cyhnce", SpellingParams.SPELLCHECK_COUNT, "3"),
  ...
  public void testWithMaxEdit2() {
    ...
    assertQ(
        reqWithPath(URI_MIN_EDIT_2, "q", "chagn", SpellingParams.SPELLCHECK_COUNT, "3"),
    ...
    assertQ(
        reqWithPath(URI_MIN_EDIT_2, "q", "chagr", SpellingParams.SPELLCHECK_COUNT, "3"),
    ...
    assertQ(
        reqWithPath(URI_MIN_EDIT_2, "q", "chacn", SpellingParams.SPELLCHECK_COUNT, "3"),
  ...
  public void testWithNonFuzzyPrefix4() {
    ...
    assertQ(
        reqWithPath(URI_NON_PREFIX_LENGTH_4, "q", "chanr", SpellingParams.SPELLCHECK_COUNT, "3"),
  ...
  public void testWithMinFuzzyLength2() {
    ...
    assertQ(
        reqWithPath(URI_MIN_FUZZY_LENGTH, "q", "chynce", SpellingParams.SPELLCHECK_COUNT, "3"),
