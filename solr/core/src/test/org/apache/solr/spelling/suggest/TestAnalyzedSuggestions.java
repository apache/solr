...
public class TestAnalyzedSuggestions extends SolrTestCaseJ4 {
  ...
  public void test() {
    assertQ(
        reqWithPath(URI, "q", "hokk", SpellingParams.SPELLCHECK_COUNT, "1"),
    ...
    assertQ(
        reqWithPath(URI, "q", "ほっk", SpellingParams.SPELLCHECK_COUNT, "1"),
    ...
    assertQ(
        reqWithPath(URI, "q", "ホッk", SpellingParams.SPELLCHECK_COUNT, "1"),
    ...
    assertQ(
        reqWithPath(URI, "q", "ﾎｯk", SpellingParams.SPELLCHECK_COUNT, "1"),
  ...
  public void testMultiple() {
    assertQ(
        reqWithPath(URI, "q", "h", SpellingParams.SPELLCHECK_COUNT, "2"),
