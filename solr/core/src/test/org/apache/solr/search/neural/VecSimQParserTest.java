...
public class VecSimQParserTest extends SolrTestCaseJ4 {
  String IDField = "id";
  ...
  public void incorrectVectorFieldType_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vecSim f=id}" + vectorToSearch, "fl", "id"),
  ...
  public void undefinedVectorField_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vecSim f=notExistent}" + vectorToSearch, "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void missingVectorField_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vecSim}" + vectorToSearch, "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void correctVectorField_shouldSearchOnThatField() {
    ...
    assertQ(
        req(CommonParams.Q, "{!vecSim f=vector2 minReturn=0.8}" + vectorToSearch, "fl", "id"),
        "//result[@numFound='3']",
  ...
  public void vectorByteEncodingField_shouldSearchOnThatField() {
    ...
    float minR =
        VectorSimilarityFunction.COSINE.compare(new byte[] {2, 2, 1, 3}, new byte[] {1, 2, 1, 2});
    assertQ(
        req(
            CommonParams.Q,
            "{!vecSim f=vector_byte_encoding minReturn=" + minR + "}" + vectorToSearch,
            "fl",
            "id"),
        "//result[@numFound='2']",
    ...
    minR =
        VectorSimilarityFunction.COSINE.compare(new byte[] {8, 3, 2, 4}, new byte[] {7, 2, 1, 3});
  ...
  public void vectorByteEncodingField_shouldRaiseExceptionIfQueryUsesFloatVectors() {
    ...
    assertQEx(
        ...
        req(
            CommonParams.Q,
            "{!vecSim f=vector_byte_encoding minReturn=0.0}" + vectorToSearch,
            "fl",
            "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void missingVectorToSearch_shouldThrowException() {
    assertQEx(
        ...
        req(CommonParams.Q, "{!vecSim f=vector minReturn=0.0}", "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void incorrectVectorToSearchDimension_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vecSim f=vector minReturn=0.0}" + vectorToSearch, "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  ...
  public void correctQuery_shouldRankBySimilarityFunction() {
    ...
    assertQ(
        req(CommonParams.Q, "{!vecSim f=vector minReturn=0.8}" + vectorToSearch, "fl", "id"),
        "//result[@numFound='8']",
  ...
  @Test
  public void vecSimQueryUsedInFilters_shouldFilterResultsBeforeTheQueryExecution() {
    String vectorToSearch = "[1.0, 2.0, 3.0, 4.0]";
    ...
    assertQ(
        req(
            ...
            "id:(3 4 9 2)",
            "fq",
            "{!vecSim f=vector minReturn=0.8}" + vectorToSearch,
            "fq",
            "id:(4 20 9)",
            "fl",
            "id"),
  ...
  @Test
  public void vecSimQueryUsedInFiltersWithPreFilter_shouldFilterResultsBeforeTheQueryExecution() {
    String vectorToSearch = "[1.0, 2.0, 3.0, 4.0]";
    ...
    assertQ(
        req(
            ...
            "id:(3 4 7 2)",
            "fq",
            "{!vecSim f=vector minReturn=0.8 preFilter='id:(1 4 7 8 9)'}" + vectorToSearch,
            "fq",
            "id:(4 20 7)",
            "fl",
            "id"),
  ...
  public void vecSimQueryUsedInFilters_rejectIncludeExclude() {
    ...
    for (String fq :
        Arrays.asList(
            "{!vecSim f=vector minReturn=0.8 includeTags=xxx}" + vectorToSearch,
            "{!vecSim f=vector minReturn=0.8 excludeTags=xxx}" + vectorToSearch)) {
      assertQEx(
          "fq={!vecSim...} incompatible with include/exclude localparams",
  ...
  public void vecSimQueryAsSubQuery() {
    ...
    // When vecSim parser is a subquery, it should not pre-filter on any global fq params
    // minReturn -> 1,4,2,10,3,7,5,6 -> fq -> 4,2,7
    assertQ(
        req(common, "fq", filt, "q", "*:* AND {!vecSim f=vector minReturn=0.8 v=$vec}"),
        "//result[@numFound='3']",
        "//result/doc[1]/str[@name='id'][.='4']",
    ...
    assertQ(
        req(common, "fq", filt, "q", "id:8^=0.01 OR {!vecSim f=vector minReturn=0.8 v=$vec}"),
        "//result[@numFound='4']",
        "//result/doc[1]/str[@name='id'][.='4']",
        "//result/doc[2]/str[@name='id'][.='2']",
        "//result/doc[3]/str[@name='id'][.='7']",
  ...
  public void vecSimQueryAsSubQuery_withPreFilter() {
    ...
    assertQ(
        req(
            common,
            "q",
            "*:* AND {!vecSim f=vector minReturn=0.8 preFilter='" + filt + "' v=$vec}"),
        "//result[@numFound='4']",
        "//result/doc[1]/str[@name='id'][.='4']",
        "//result/doc[2]/str[@name='id'][.='2']",
    ...
    assertQ(
        req(
            ...
            "id:(1 9 20 3 5 7 8)",
            "q",
            "id:8^=100 OR {!vecSim f=vector minReturn=0.8 preFilter='" + filt + "' v=$vec}"),
        "//result[@numFound='3']",
        "//result/doc[1]/str[@name='id'][.='8']",
        "//result/doc[2]/str[@name='id'][.='3']",
        "//result/doc[3]/str[@name='id'][.='7']");
  ...
  public void vecSimQueryAsSubQuery_rejectIncludeExclude() {
    ...
    for (String subq :
        Arrays.asList(
            "{!vecSim f=vector minReturn=0.8 includeTags=xxx v=$vec}",
            "{!vecSim f=vector minReturn=0.8 excludeTags=xxx v=$vec}")) {
      assertQEx(
  ...
  public void vecSimQueryWithFilterQuery_singlePreFilterEquivilence() {
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            req(common, "q", "{!vecSim f=vector minReturn=0.8}" + vectorToSearch, "fq", filt),
            req(
                common,
                "q",
                "{!vecSim f=vector preFilter=\"" + filt + "\" minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector preFilter=$my_filt minReturn=0.8}" + vectorToSearch,
                "my_filt",
                filt))) {
      assertQ(
          req,
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            req(
                common,
                "q",
                "{!vecSim f=vector " + minR + "}" + vectorToSearch,
                "fq",
                fx,
                "fq",
                fy),
            ...
            req(
                common,
                "q",
                "{!vecSim f=vector preFilter=$fx preFilter=$fy " + minR + "}" + vectorToSearch,
                "fx",
                fx,
                "fy",
                fy),
            req(
                common,
                "q",
                "{!vecSim f=vector preFilter=$multi_filt " + minR + "}" + vectorToSearch,
                "multi_filt",
                fx,
                "multi_filt",
                fy))) {
  ...
  public void vecSimQueryWithPreFilter_rejectIncludeExclude() {
    ...
    assertQEx(
        ...
        req(
            "q",
            "{!vecSim f=vector minReturn=0.8 preFilter='id:1' includeTags=xxx}" + vectorToSearch),
        SolrException.ErrorCode.BAD_REQUEST);
    assertQEx(
        "vecSim preFilter localparm incompatible with include/exclude localparams",
        "does not support combining preFilter localparam with either",
        ...
        req(
            "q",
            "{!vecSim f=vector minReturn=0.8 preFilter='id:1' excludeTags=xxx}" + vectorToSearch),
        SolrException.ErrorCode.BAD_REQUEST);
  }

  @Test
  public void vecSimQueryWithFilterQuery_preFilterLocalParamOverridesGlobalFilters() {
    final String vectorToSearch = "[1.0, 2.0, 3.0, 4.0]";

    // trivial case: empty preFilter localparam means no pre-filtering
    assertQ(
        req(
            "q", "{!vecSim f=vector preFilter='' minReturn=0.8}" + vectorToSearch,
            "fq", "-id:4",
            "fl", "id"),
        "//result[@numFound='7']",
        "//result/doc[1]/str[@name='id'][.='1']",
    ...
    assertQ(
        req(
            "q", "{!vecSim f=vector preFilter='id:(3 4 9 2 7 8)' minReturn=0.8}" + vectorToSearch,
            "fq", "-id:4",
            "fl", "id"),
        "//result[@numFound='3']",
        "//result/doc[1]/str[@name='id'][.='2']",
  ...
  public void vecSimQueryWithFilterQuery_localParamIncludeExcludeTags() {
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(common, "q", "{!vecSim f=vector minReturn=0.8}" + vectorToSearch),
            // diff ways of explicitly requesting both fq params
            req(common, "q", "{!vecSim f=vector includeTags=aa minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=aa excludeTags='' minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=aa excludeTags=bogus minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=xx includeTags=yy minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=xx,yy,bogus minReturn=0.8}" + vectorToSearch))) {
      assertQ(
          req,
          "//result[@numFound='3']",
  ...
  public void vecSimQueryWithFilterQuery_localParamsDisablesAllPreFiltering() {
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(common, "q", "{!vecSim f=vector preFilter='' minReturn=0.8}" + vectorToSearch),
            // diff ways of explicitly including none of the global fq params
            req(common, "q", "{!vecSim f=vector includeTags='' minReturn=0.8}" + vectorToSearch),
            req(common, "q", "{!vecSim f=vector includeTags=bogus minReturn=0.8}" + vectorToSearch),
            // diff ways of explicitly excluding all of the global fq params
            req(common, "q", "{!vecSim f=vector excludeTags=aa minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=aa excludeTags=aa minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=aa excludeTags=xx,yy minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=xx,yy excludeTags=aa minReturn=0.8}"
                    + vectorToSearch),
            req(common, "q", "{!vecSim f=vector excludeTags=xx,yy minReturn=0.8}" + vectorToSearch),
            req(common, "q", "{!vecSim f=vector excludeTags=aa minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector excludeTags=xx excludeTags=yy minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector excludeTags=xx excludeTags=yy,bogus minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector excludeTags=xx,yy,bogus minReturn=0.8}" + vectorToSearch))) {
      assertQ(req, "//result[@numFound='1']", "//result/doc[1]/str[@name='id'][.='7']");
    }
  }

  @Test
  public void vecSimQueryWithFilterQuery_localParamCombinedIncludeExcludeTags() {
    final String vectorToSearch = "[1.0, 2.0, 3.0, 4.0]";
    final SolrParams common =
        params(
            "fl", "id",
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=yy,bogus minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=yy excludeTags='' minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector excludeTags=xx,bogus minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=yy excludeTags=xx minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
                "{!vecSim f=vector includeTags=aa excludeTags=xx minReturn=0.8}"
                    + vectorToSearch))) {
      assertQ(req, "//result[@numFound='1']", "//result/doc[1]/str[@name='id'][.='7']");
    }
  }
  ...
  public void vecSimQueryWithMultiSelectFaceting_excludeTags() {
    ...
    final SolrParams common =
        params(
            "fl", "id",
            "indent", "true",
            "q", "{!vecSim f=vector minReturn=0.9 excludeTags=facet_click v=$vec}",
            "vec", vectorToSearch,
