 ...
 *
 * @see StdValueSourceParsers#standardValueSourceParsers
...
public class QueryEqualityTest extends SolrTestCaseJ4 {
  ...
  public static void afterClassParserCoverageTest() {
    ...
    for (String name : QParserStdPlugins.standardPlugins.keySet()) {
      assertTrue("testParserCoverage was run w/o any other method explicitly testing qparser: " + name, qParsersTested.contains(name));
    }

    for (final String name : StdValueSourceParsers.standardValueSourceParsers.keySet()) {
  ...
  public void testCompares() throws Exception {
    ...
    SolrTestCaseUtil.expectThrows(AssertionError.class, "expected error, functions are not equal", () -> assertFuncEquals("eq(foo_i,2)", "lt(foo_i,2)"));
  }
  ...
  public void testPayloadScoreQuery() throws Exception {
    ...
    SolrTestCaseUtil.expectThrows(AssertionError.class, "queries should not have been equal",
        () -> assertQueryEquals("payload_score", "{!payload_score f=foo_dpf v=query func=min includeSpanScore=false}", "{!payload_score f=foo_dpf v=query func=min includeSpanScore=true}"));
  }

  public void testPayloadCheckQuery() throws Exception {
    SolrTestCaseUtil.expectThrows(AssertionError.class, "queries should not have been equal",
        () -> assertQueryEquals("payload_check", "{!payload_check f=foo_dpf payloads=2}one", "{!payload_check f=foo_dpf payloads=2}two"));
  }
  ...
  public void testBoolQuery() throws Exception {
    ...
    SolrTestCaseUtil
        .expectThrows(AssertionError.class, "queries should not have been equal", () -> assertQueryEquals("bool", "{!bool must='{!lucene}foo_s:a'}", "{!bool should='{!lucene}foo_s:a'}"));
  }
