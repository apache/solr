...
public class RankQParserPluginTest extends SolrTestCaseJ4 {
  ...
  public void testParamCompatibility() {
    ...
    assertEquals(
        "RankQParserPlugin.SCALING_FACTOR changed in an incompatible way",
        "scalingFactor",
        SCALING_FACTOR);
    ...
    assertSyntaxError(
        ...
        () ->
            getRankQParser(
                ...
                .parse());
    assertSyntaxError(
        "Expecting bad scaling factor",
        "scalingFactor must be",
        () ->
            getRankQParser(
                    params(
                        FIELD, "rank_1",
  ...
  public void testParseLog() throws IOException, SyntaxError {
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedLogToString(2.5f), 1),
        params(
            FIELD, "rank_1",
            FUNCTION, "log",
            SCALING_FACTOR, "2.5",
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedLogToString(1), 2.5f),
        params(
            FIELD, "rank_1",
            FUNCTION, "log",
            SCALING_FACTOR, "1",
  ...
  public void testParseSigm() throws IOException, SyntaxError {
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedSigmoidToString(1.5f, 2f), 1),
        params(
            FIELD, "rank_1",
            FUNCTION, "sigm",
            PIVOT, "1.5",
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedSigmoidToString(1.5f, 2f), 2),
        params(
            FIELD, "rank_1",
            FUNCTION, "sigm",
            PIVOT, "1.5",
  ...
  public void testParseSatu() throws IOException, SyntaxError {
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedSaturationToString(1.5f), 1),
        params(
            FIELD, "rank_1",
            FUNCTION, "satu",
            PIVOT, "1.5",
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedSaturationToString(1.5f), 2),
        params(
            FIELD, "rank_1",
            FUNCTION, "satu",
            PIVOT, "1.5",
    ...
    assertValidRankQuery(
        expectedFeatureQueryToString("rank_1", expectedSaturationToString(null), 1),
        params(
            FIELD, "rank_1",
            FUNCTION, "satu"));
