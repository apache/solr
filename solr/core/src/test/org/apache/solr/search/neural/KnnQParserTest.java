...
public class KnnQParserTest extends SolrTestCaseJ4 {
  ...
  public void knnQueryWithSeedQuery_shouldPerformSeededKnnVectorQuery() {
    ...
    assertQ(
        req(
            ...
            "true"),
        "//result[@numFound='4']",
        "//str[@name='parsedquery'][.='SeededKnnVectorQuery(SeededKnnVectorQuery{seed=id:1 id:4 id:7 id:8 id:9, seedWeight=null, delegate=SolrKnnFloatVectorQuery:vector[1.0,...][8]})']");
  }
  ...
  public void byteKnnQueryWithSeedQuery_shouldPerformSeededKnnVectorQuery() {
    ...
    assertQ(
        req(
            ...
            "true"),
        "//result[@numFound='4']",
        "//str[@name='parsedquery'][.='SeededKnnVectorQuery(SeededKnnVectorQuery{seed=id:1 id:4 id:7 id:8 id:9, seedWeight=null, delegate=SolrKnnByteVectorQuery:vector_byte_encoding[2,...][8]})']");
  }
  ...
  public void knnQueryWithKnnSeedQuery_shouldPerformSeededKnnVectorQuery() {
    ...
    assertQ(
        req(
            ...
            "true"),
        "//result[@numFound='4']",
        "//str[@name='parsedquery'][.='SeededKnnVectorQuery(SeededKnnVectorQuery{seed=SolrKnnFloatVectorQuery:vector[0.1,...][8], seedWeight=null, delegate=SolrKnnFloatVectorQuery:vector[1.0,...][8]})']");
  }
  ...
  public void
    ...
    assertQ(
        ...
        // topK
        // value
        "//str[@name='parsedquery'][contains(.,'delegate=SolrKnnFloatVectorQuery:vector[1.0,...][8]')]");
  }
