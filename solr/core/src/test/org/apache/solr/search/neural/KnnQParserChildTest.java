  ...
  public void testDiverseKids() {
    ...
    for (int iter = 0; iter < numIters; iter++) {
      ...
      assertQ(
          req(
              "q",
              "{!knn f=vector topK=$k childrenOf='type_s:PARENT' allParents='type_s:PARENT'}"
      ...
      assertQ(
          req(
              "q",
              "{!knn f=vector_byte_encoding topK=$k childrenOf='type_s:PARENT' allParents='type_s:PARENT'}"
