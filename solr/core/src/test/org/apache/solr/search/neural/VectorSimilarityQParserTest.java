...
public class VectorSimilarityQParserTest extends SolrTestCaseJ4 {
  ...
  public void incorrectVectorFieldType_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vectorSimilarity f=id}" + vectorToSearch, "fl", "id"),
  ...
  public void undefinedVectorField_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vectorSimilarity f=notExistent}" + vectorToSearch, "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void missingVectorField_shouldThrowException() {
    ...
    assertQEx(
        ...
        req(CommonParams.Q, "{!vectorSimilarity}" + vectorToSearch, "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void vectorByteEncodingField_shouldSearchOnThatField() {
    ...
    assertQ(
        req(
            CommonParams.Q,
            "{!vectorSimilarity f=vector_byte_encoding minReturn=" + minR + "}" + vectorToSearch,
            "fl",
            "id"),
        "//result[@numFound='2']",
  ...
  public void vectorByteEncodingField_shouldRaiseExceptionIfQueryUsesFloatVectors() {
    ...
    assertQEx(
        ...
        req(
            CommonParams.Q,
            "{!vectorSimilarity f=vector_byte_encoding minReturn=0.0}" + vectorToSearch,
            "fl",
            "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void missingVectorToSearch_shouldThrowException() {
    assertQEx(
        ...
        req(CommonParams.Q, "{!vectorSimilarity f=vector minReturn=0.0}", "fl", "id"),
        SolrException.ErrorCode.BAD_REQUEST);
  }
  ...
  public void vecSimQueryUsedInFilters_rejectIncludeExclude() {
    ...
    for (String fq :
        Arrays.asList(
            "{!vectorSimilarity f=vector minReturn=0.8 includeTags=xxx}" + vectorToSearch,
            "{!vectorSimilarity f=vector minReturn=0.8 excludeTags=xxx}" + vectorToSearch)) {
      assertQEx(
          "fq={!vectorSimilarity...} incompatible with include/exclude localparams",
  ...
  public void vecSimQueryAsSubQuery() {
    ...
    assertQ(
        req(common, "fq", filt, "q", "*:* AND {!vectorSimilarity f=vector minReturn=0.8 v=$vec}"),
        "//result[@numFound='3']",
        "//result/doc[1]/str[@name='id'][.='4']",
  ...
  public void vecSimQueryAsSubQuery_withPreFilter() {
    ...
    assertQ(
        req(
            common,
            "q",
            "*:* AND {!vectorSimilarity f=vector minReturn=0.8 preFilter='" + filt + "' v=$vec}"),
        "//result[@numFound='4']",
        "//result/doc[1]/str[@name='id'][.='4']",
        "//result/doc[2]/str[@name='id'][.='2']",
  ...
  public void vecSimQueryAsSubQuery_rejectIncludeExclude() {
    ...
    for (String subq :
        Arrays.asList(
            "{!vectorSimilarity f=vector minReturn=0.8 includeTags=xxx v=$vec}",
            "{!vectorSimilarity f=vector minReturn=0.8 excludeTags=xxx v=$vec}")) {
      assertQEx(
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector preFilter=$my_filt minReturn=0.8}" + vectorToSearch,
                "my_filt",
                filt))) {
      assertQ(
          req,
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector preFilter=$multi_filt " + minR + "}" + vectorToSearch,
                "multi_filt",
                fx,
                "multi_filt",
                fy))) {
  ...
  public void vecSimQueryWithFilterQuery_preFilterLocalParamOverridesGlobalFilters() {
    ...
    assertQ(
        req(
            "q", "{!vectorSimilarity f=vector preFilter='' minReturn=0.8}" + vectorToSearch,
            "fq", "-id:4",
            "fl", "id"),
        "//result[@numFound='7']",
        "//result/doc[1]/str[@name='id'][.='1']",
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector includeTags=aa excludeTags=bogus minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector includeTags=aa excludeTags=xx,yy minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector excludeTags=xx excludeTags=yy,bogus minReturn=0.8}"
                    + vectorToSearch),
            req(
                common,
                "q",
    ...
    for (SolrQueryRequest req :
        Arrays.asList(
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector includeTags=yy,bogus minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector excludeTags=xx,bogus minReturn=0.8}" + vectorToSearch),
            req(
                common,
                "q",
            ...
            req(
                common,
                "q",
                "{!vectorSimilarity f=vector includeTags=aa excludeTags=xx minReturn=0.8}"
                    + vectorToSearch))) {
      assertQ(req, "//result[@numFound='1']", "//result/doc[1]/str[@name='id'][.='7']");
    }
  }
  ...
  public void vecSimQueryWithMultiSelectFaceting_excludeTags() {
    ...
    final SolrParams common =
        params(
            "fl", "id",
            "indent", "true",
            "q", "{!vectorSimilarity f=vector minReturn=0.9 excludeTags=facet_click v=$vec}",
            "vec", vectorToSearch,
