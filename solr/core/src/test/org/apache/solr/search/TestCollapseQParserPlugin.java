...
public class TestCollapseQParserPlugin extends SolrTestCaseJ4 {
  ...
  private void testCollapseQueries(String group, String hint, NumberType numberType) {
    String lowGroup;
    String highGroup;
    ...
    String[] doc = {
      "id", "1", "term_s", "YYYY", group, lowGroup, "test_i", "5", "test_l", "10", "test_f", "2000"
    };
    assertU(adoc(doc));
    assertU(commit());
    String[] doc1 = {
      "id", "2", "term_s", "YYYY", group, lowGroup, "test_i", "50", "test_l", "100", "test_f", "200"
    };
    assertU(adoc(doc1));
    ...
    String[] doc4 = {
      "id", "5", "term_s", "YYYY", group, highGroup, "test_i", "4", "test_l", "10", "test_f", "2000"
    };
    assertU(adoc(doc4));
    assertU(commit());
    String[] doc5 = {
    ...
    String[] doc6 = {
      "id", "7", "term_s", "YYYY", group, lowGroup, "test_i", "8", "test_l", "50", "test_f", "300"
    };
    assertU(adoc(doc6));
    assertU(commit());
  ...
  public void testNullGroupNumericVsStringCollapse() {
    ...
    for (String f : Arrays.asList("group_i", "group_l", "group_s")) {
