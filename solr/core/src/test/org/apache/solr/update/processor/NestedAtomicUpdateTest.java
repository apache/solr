...
public class NestedAtomicUpdateTest extends SolrTestCaseJ4 {
  ...
  public void testMergeChildDoc() {
    ...
    SolrInputDocument addedDoc =
        sdoc("id", "1", "cat_ss", Map.of("add", "bbb"), "child", Map.of("add", sdocs(newChildDoc)));
  ...
  public void testMergeChildDocsWithSameId() {
    ...
    SolrInputDocument existingDoc =
        sdoc(
            ...
            "1",
            "child",
            new ArrayList<>(sdocs(existingChild)));
    ...
    SolrInputDocument updateDoc =
        sdoc(
            ...
            "1",
            "cat_ss",
            Map.of("add", "bbb"), // add value to collection on parent
            "child",
            Map.of("add", sdocs(updatedChildDoc))); // child with same id and updated "cat_ss" field
    ...
    assertDocContainsSubset(
        updatedChildDoc, ((SolrInputDocument) existingDoc.getFieldValues("child").toArray()[0]));
  }
  ...
  public void testMergeChildDocsWithSameAndNestedSet() {
    ...
    SolrInputDocument updatedChildDoc = sdoc("id", "2", "cat_ss", Map.of("set", "updated child"));
    SolrInputDocument updateDoc =
        sdoc(
            "id",
            "1",
            ...
            Map.of(
                "add",
                sdocs(updatedChildDoc))); // child with same id and nested set on "cat_ss" field
    ...
    assertDocContainsSubset(
        ...
        ((SolrInputDocument) existingDoc.getFieldValues("child").toArray()[0]));
  }
  ...
  public void testMergeChildDocsWithMultipleChildDocs() {
    ...
    SolrInputDocument existingDoc =
        sdoc(
            ...
            "1",
            "child",
            new ArrayList<>(sdocs(existingChild, nonMatchingExistingChild)));
  ...
  public void testAtomicUpdateNonExistingChildException() {
    ...
    SolrInputDocument updateDoc =
        sdoc(
            ...
            "1",
            "child_ss",
            Map.of("add", sdoc("id", "3", "cat_ss", Map.of("set", "child2")))); // an atomic update
  ...
  public void testBlockAtomicInplaceUpdates() throws Exception {
    ...
    doc = sdoc("id", "1", "_root_", "1", "children", Map.of("add", docs));
    ...
    for (int i = 10; i < 20; ++i) {
      doc =
          sdoc("id", String.valueOf(i), "_root_", "1", "inplace_updatable_int", Map.of("inc", "1"));
      addAndGetVersion(doc, null);
      assertU(commit());
    }
    ...
    for (int i = 10; i < 20; ++i) {
      docs =
          IntStream.range(i * 10, (i * 10) + 5)
              ...
              .toList();
      doc = sdoc("id", String.valueOf(i), "_root_", "1", "grandChildren", Map.of("add", docs));
      addAndGetVersion(doc, null);
      assertU(commit());
    }
  ...
  public void testBlockAtomicQuantities() throws Exception {
    ...
    List<SolrInputDocument> docs =
        IntStream.range(10, 20)
            ...
            .collect(Collectors.toList());
    doc = sdoc("id", "1", "children", Map.of("add", docs));
    addAndGetVersion(doc, null);
  ...
  public void testBlockAtomicStack() throws Exception {
    ...
    doc = sdoc("id", "1", "child1", Map.of("add", sdocs(sdoc("id", "3", "child_s", "child"))));
    addAndGetVersion(doc, null);
    ...
    doc = sdoc("id", "1", "child2", Map.of("add", sdocs(sdoc("id", "8", "child_s", "child"))));
    addAndGetVersion(doc, null);

    assertU(commit());

    assertJQ(
        req("q", "id:1", "fl", "*, [child]", "sort", "id asc"), // fails
        "/response/numFound==1",
        "/response/docs/[0]/id=='1'",
        "/response/docs/[0]/child1/[0]/id=='2'",
        "/response/docs/[0]/child1/[0]/child_s=='child'",
    ...
    doc = sdoc("id", "1", "new_s", Map.of("add", "new string"));
    addAndGetVersion(doc, null);
  ...
  public void testBlockAtomicAdd() throws Exception {
    ...
    SolrInputDocument doc = sdoc("id", "1", "cat_ss", new String[] {"aaa", "ccc"}, "child1", sdoc2);
    assertU(adoc(doc));
    ...
    SolrInputDocument block =
        RealTimeGetComponent.getInputDocument(
            core, rootDocId, rootDocId, null, null, ROOT_WITH_CHILDREN);
    ...
    doc =
        sdoc(
            ...
            Map.of("add", "bbb"),
            "child2",
            Map.of("add", sdoc("id", "3", "cat_ss", "child")));
    addAndGetVersion(doc, null);
    ...
    doc =
        sdoc(
            ...
            "1",
            "child3",
            Map.of("add", sdoc("id", "4", "cat_ss", "grandChild")));
    addAndGetVersion(doc, null);
    ...
    doc =
        sdoc(
            ...
            "1",
            "child4",
            Map.of("add", sdoc("id", "5", "cat_ss", "greatGrandChild")));
    addAndGetVersion(doc, null);
    ...
    doc =
        sdoc(
            ...
            "1",
            "child4",
            Map.of("add", sdoc("id", "6", "cat_ss", "greatGrandChild")));
    addAndGetVersion(doc, null);
  ...
  public void testBlockAtomicSet() throws Exception {
    ...
    doc =
        sdoc(
            ...
            "1",
            "cat_ss",
            Map.of("set", Arrays.asList("aaa", "bbb")),
            "child1",
            Map.of("set", sdoc("id", "3", "cat_ss", "child")));
    addAndGetVersion(doc, null);
    ...
    doc =
        sdoc("id", "3", "_root_", "1", "child2", Map.of("set", sdoc("id", "4", "cat_ss", "child")));
    addAndGetVersion(doc, null);
  ...
  public void testAtomicUpdateDeleteNoRootField() throws Exception {
    ...
    doc = sdoc("id", "1", "child1", Map.of("add", sdoc("id", "2", "cat_ss", "child")));
    addAndGetVersion(doc, null);
  ...
  public void testBlockAtomicRemove() throws Exception {
    ...
    SolrInputDocument doc =
        sdoc(
            ...
            new String[] {"aaa", "ccc"},
            "child1",
            sdocs(sdoc2, sdoc("id", "3", "cat_ss", "child")));
    assertU(adoc(doc));
    ...
    doc = sdoc("id", "1", "child1", Map.of("remove", sdoc("id", "3", "cat_ss", "child")));
    addAndGetVersion(doc, null);
  ...
  public void testIncorrectlyUpdateChildDoc() {
    ...
    SolrException e =
        expectThrows(
            SolrException.class,
            () -> {
              addAndGetVersion(sdoc("id", "2", "grandchild", Map.of("set", sdoc("id", "3"))), null);
            });
    assertTrue(
        e.toString(),
        e.getMessage()
            .contains(
                "Attempted an atomic/partial update to a "
