...
public class TestFieldResource extends SolrRestletTestBase {
  ...
  public void testGetField() {
    assertQ(
        ...
        "/response/lst[@name='field']/bool[@name='uninvertible'] = 'false'",
        ...
        "/response/lst[@name='field']/bool[@name='docValuesSkipList'] = 'false'");
  }
  ...
  public void testJsonGetField() throws Exception {
    assertJQ(
        "/schema/fields/test_postv?indent=on&showDefaults=true",
        "/field/name=='test_postv'",
        "/field/type=='text'",
        "/field/indexed==true",
        "/field/stored==true",
        "/field/uninvertible==false",
