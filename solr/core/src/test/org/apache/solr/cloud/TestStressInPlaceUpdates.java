...
public class TestStressInPlaceUpdates extends SolrCloudBridgeTestCase {
   ...
   */
  public SolrClient getClientForLeader() throws KeeperException, InterruptedException, TimeoutException {
    ZkStateReader zkStateReader = cloudClient.getZkStateReader();

    // Wait for the leader to be elected/published; reading getLeader() off a cluster-state snapshot
    // can return null if it races leadership establishment.
    Replica leader = zkStateReader.getLeaderRetry(COLLECTION, SHARD1, 10000);
