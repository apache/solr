...
public class DeleteNodeTest extends SolrCloudTestCase {
  ...
  public void test() throws Exception {
    ...
    state = cloudClient.getClusterStateProvider().getClusterState();
    ...
    if (log.isInfoEnabled()) {
      log.info("####### DocCollection after: {}", cloudClient.getClusterStateProvider().getClusterState().getCollection(coll));
    }
    if (shouldFail) {
