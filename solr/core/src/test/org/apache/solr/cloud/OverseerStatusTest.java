...
public class OverseerStatusTest extends SolrCloudTestCase {
  ...
  public void test() throws Exception {
    ...
    // Collection API call shouldn't fail
    ...
    if (!cluster.getOpenOverseer().getDistributedClusterStateUpdater().isDistributedStateUpdate()) {
      // Note the "create" key here is in a different map from the "create" key above. Above it's Collection creation in the Collection API, here it's the collection creation from the cluster state updater perspective.
      createcollection =
          (SimpleOrderedMap<Object>)
