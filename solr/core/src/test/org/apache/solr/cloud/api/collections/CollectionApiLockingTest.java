  ...
  private void monothreadedTests(CollectionApiLockFactory apiLockingHelper) {
    ...
    DistributedMultiLock collLock =
        apiLockingHelper.createCollectionApiLock(
            new AdminCmdContext(CollectionParams.CollectionAction.CREATE), COLLECTION_NAME, null, null);
    ...
    DistributedMultiLock shard1Lock =
        apiLockingHelper.createCollectionApiLock(
            new AdminCmdContext(CollectionParams.CollectionAction.SPLITSHARD), COLLECTION_NAME, SHARD1_NAME, null);
    ...
    DistributedMultiLock shard2Lock =
        apiLockingHelper.createCollectionApiLock(
            new AdminCmdContext(CollectionParams.CollectionAction.SPLITSHARD), COLLECTION_NAME, SHARD2_NAME, null);
    ...
    DistributedMultiLock replicaShard1Lock =
        apiLockingHelper.createCollectionApiLock(
            new AdminCmdContext(CollectionParams.CollectionAction.MOCK_REPLICA_TASK), COLLECTION_NAME, SHARD1_NAME, REPLICA_NAME);
    assertFalse(
    ...
    DistributedMultiLock replicaShard2Lock =
        apiLockingHelper.createCollectionApiLock(
            new AdminCmdContext(CollectionParams.CollectionAction.MOCK_REPLICA_TASK), COLLECTION_NAME, SHARD2_NAME, REPLICA_NAME);
    assertFalse(
