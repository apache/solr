...
public class SimpleCollectionCreateDeleteTest extends AbstractFullDistribZkTestBase {
    ...
    public void testDeleteAlsoDeletesAutocreatedConfigSet() throws Exception {
        ...
        if (request.get("success") != null) {
            ...
            assertFalse("The auto-created config set should have been deleted with its collection", ZkConfigSetService.listConfigs(cloudClient.getZkStateReader().getZkClient()).contains(configName));
        }
    }
    ...
    public void testDeleteDoesNotDeleteSharedAutocreatedConfigSet() throws Exception {
        ...
        if (requestInitial.get("success") != null) {
            ...
            assertTrue("The auto-created config set should NOT have been deleted. Another collection is using it.", ZkConfigSetService.listConfigs(cloudClient.getZkStateReader().getZkClient()).contains(configName));
            ...
            assertFalse("The auto-created config set should have been deleted now. No collection is referencing it.", ZkConfigSetService.listConfigs(cloudClient.getZkStateReader().getZkClient()).contains(configName));
        }
    }
