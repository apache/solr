...
public class PrometheusMetricsServletTest {
  ...
  public void testGarbageCollectorMetricsApiCaller() throws Exception {
    ...
    String output =
        "# HELP collection_count_g1_young_generation the number of GC invocations for G1 Young Generation\n"
    ...
    assertMetricsApiCaller(
        new PrometheusMetricsServlet.GarbageCollectorMetricsApiCaller(), json, 22, output);
  }
  ...
  public void testMemoryMetricsApiCaller() throws Exception {
    ...
    String output =
        "# HELP committed_memory_heap amount of memory in bytes that is committed for the Java virtual machine to use in the heap\n"
  ...
  public void testOsMetricsApiCaller() throws Exception {
    String json =
        "{\n"
            ...
            + "      \"os.version\":\"10.15.7\"}}}";
    String output =
        "# HELP open_file_descriptors the number of open file descriptors on the filesystem\n"
  ...
  public void testThreadMetricsApiCaller() throws Exception {
    ...
    String output =
        "# HELP threads_count number of threads\n"
  ...
  public void testStatusCodeMetricsApiCaller() throws Exception {
    ...
    String output =
        "# HELP status_codes_2xx cumulative number of responses with 2xx status codes\n"
            ...
            + "status_codes_5xx 77\n";
    assertMetricsApiCaller(
        new PrometheusMetricsServlet.StatusCodeMetricsApiCaller(), json, 9, output);
  }
  ...
  public void testCoresMetricsApiCaller() throws Exception {
    String json =
        "{\n"
            ...
            + "      \"QUERY./get[shard].requestTimes\":{\"count\":10},\n"
            + "      \"QUERY./select.requestTimes\":{\"count\":36},\n"
            ...
            + "      \"QUERY./get[shard].requestTimes\":{\"count\":26},\n"
            + "      \"QUERY./select.requestTimes\":{\"count\":39},\n"
  ...
  public void testCoresMetricsApiCallerMissingIndex() throws Exception {
    String json =
        "{\n"
            ...
            + "      \"QUERY./select.requestTimes\":{\"count\":30},\n"
            ...
            + "      \"QUERY./select.requestTimes\":{\"count\":33},\n"
