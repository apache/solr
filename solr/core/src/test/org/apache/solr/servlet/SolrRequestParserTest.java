...
//
//  @BeforeClass
//  public static void beforeSolrRequestParserTest() throws Exception {
...
//
//  @AfterClass
//  public static void afterSolrRequestParserTest() {
//    parser = null;
//  }
//
//  @Test
...
//
//  @Test
////  public static void testUrlParamParsing() throws Exception
////  {
...
////      SolrParams params = SolrRequestParsers.getInstance().parseQueryString( "val="+tst[1] );
////      assertEquals( tst[0], params.get( "val" ) );
////      params = SolrRequestParsers.getInstance().parseQueryString( "val="+tst[1]+"&" );
////      assertEquals( tst[0], params.get( "val" ) );
////      params = SolrRequestParsers.getInstance().parseQueryString( "&&val="+tst[1]+"&" );
////      assertEquals( tst[0], params.get( "val" ) );
////      params = SolrRequestParsers.getInstance().parseQueryString( "&&val="+tst[1]+"&&&val="+tst[1]+"&" );
////      assertArrayEquals(new String[]{tst[0],tst[0]}, params.getParams("val") );
////   }
////
////    SolrParams params = SolrRequestParsers.getInstance().parseQueryString("val");
////    assertEquals("", params.get("val"));
////
////    params = SolrRequestParsers.getInstance().parseQueryString("val&foo=bar=bar&muh&");
////    assertEquals("", params.get("val"));
...
////      SolrTestCaseUtil.expectThrows(SolrException.class, () -> SolrRequestParsers.getInstance().parseQueryString(s));
////    }
////  }
////
////  @Test
