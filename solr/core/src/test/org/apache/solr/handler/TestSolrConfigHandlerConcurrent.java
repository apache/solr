...
public class TestSolrConfigHandlerConcurrent extends AbstractFullDistribZkTestBase {
  ...
  public void test() throws Exception {
    Map<?, ?> editable_prop_map =
        (Map<?, ?>)
            Utils.fromJSONResource(
                getClass().getClassLoader(), "EditableSolrConfigAttributes.json");
  ...
  public static LinkedHashMapWriter getAsMap(String uri, CloudSolrClient cloudClient)
    ...
    try {
      entity = ((CloudHttp1SolrClient) cloudClient).getHttpClient().execute(get).getEntity();
