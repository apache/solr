...
public class WaitForFinalStateRequestBodyOmittedFieldTest extends SolrTestCase {
  ...
  @Test
  public void testOmittedFieldDeserializesToNullNotFalse() throws Exception {
    assertNull(mapper.readValue("{}", CreateCollectionRequestBody.class).waitForFinalState);
    assertNull(mapper.readValue("{}", CreateShardRequestBody.class).waitForFinalState);
    assertNull(mapper.readValue("{}", CreateReplicaRequestBody.class).waitForFinalState);
  }
}
