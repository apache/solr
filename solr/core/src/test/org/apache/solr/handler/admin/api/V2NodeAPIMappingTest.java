...
public class V2NodeAPIMappingTest {
    ...
    public void testOverseerOpApiAllProperties() throws Exception {
        final SolrParams v1Params = captureConvertedCoreV1Params("/node", "POST",
                "{" +
                        "\"overseer-op\": {" +
                          "\"op\": \"asdf\", " +
    ...
    public void testSystemPropsApiAllProperties() throws Exception {
        ...
        final SolrParams v1Params = captureConvertedPropertiesV1Params("/node/properties", "GET", solrParams);
    ...
    public void testThreadDumpApiAllProperties() throws Exception {
        ...
        final SolrParams v1Params = captureConvertedThreadDumpV1Params("/node/threads", "GET", solrParams);
    ...
    public void testHealthCheckApiAllProperties() throws Exception {
        ...
        final SolrParams v1Params = captureConvertedHealthCheckV1Params("/node/health", "GET", solrParams);
    ...
    private SolrParams captureConvertedCoreV1Params(String path, String method, String v2RequestBody) throws Exception {
        return doCaptureParams(path, method, new ModifiableSolrParams(), v2RequestBody, mockCoresHandler);
    }

    private SolrParams captureConvertedSystemV1Params(String path, String method, SolrParams inputParams) throws Exception {
        return doCaptureParams(path, method, inputParams, null, mockSystemInfoHandler);
    }

    private SolrParams captureConvertedLoggingV1Params(String path, String method, SolrParams inputParams) throws Exception {
        return doCaptureParams(path, method, inputParams, null, mockLoggingHandler);
    }

    private SolrParams captureConvertedPropertiesV1Params(String path, String method, SolrParams inputParams) throws Exception {
        return doCaptureParams(path, method, inputParams, null, mockPropertiesHandler);
    }

    private SolrParams captureConvertedHealthCheckV1Params(String path, String method, SolrParams inputParams) throws Exception {
        return doCaptureParams(path, method, inputParams, null, mockHealthCheckHandler);
    }

    private SolrParams captureConvertedThreadDumpV1Params(String path, String method, SolrParams inputParams) throws Exception {
        return doCaptureParams(path, method, inputParams, null, mockThreadDumpHandler);
    }

    private SolrParams doCaptureParams(String path, String method, SolrParams inputParams, String v2RequestBody, RequestHandlerBase mockHandler) throws Exception {
        ...
        final LocalSolrQueryRequest req = new LocalSolrQueryRequest(null, inputParamsMap) {
            @Override
