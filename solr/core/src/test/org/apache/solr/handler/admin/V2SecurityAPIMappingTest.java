...
public class V2SecurityAPIMappingTest extends SolrTestCaseJ4 {
    ...
    // Test the GET /cluster/security/[authentication|authorization] APIs registered regardless of security plugin
    @Test
    ...
    // Test the POST /cluster/security/[authentication|authorization] APIs registered when no plugins are configured.
    @Test
    public void testDefaultPostAPIs() {
        apiBag.registerObject(new DefaultUpdateAuthenticationConfigAPI(mockHandler));
        apiBag.registerObject(new DefaultUpdateAuthorizationConfigAPI(mockHandler));
        ...
        // Authz API
        final AnnotatedApi updateAuthzConfig = assertAnnotatedApiExistsFor("POST", "/cluster/security/authorization");
    ...
    public void testBasicAuthApiMapping() {
        ...
        assertTrue("Expected 'set-user' to be in the command list: " + commandNames, commandNames.contains("set-user"));
        assertTrue("Expected 'delete-user' to be in the command list: " + commandNames, commandNames.contains("delete-user"));
    }
    ...
    public void testMultiAuthApiMapping() {
        ...
        assertTrue("Expected 'set-user' to be in the command list: " + commandNames, commandNames.contains("set-user"));
        assertTrue("Expected 'delete-user' to be in the command list: " + commandNames, commandNames.contains("delete-user"));
        assertTrue("Expected 'set-property' to be in the command list: " + commandNames, commandNames.contains("set-property"));
    }
    ...
    public void testRuleBasedAuthzApiMapping() {
        ...
        assertTrue("Expected 'set-permission' to be in the command list: " + commandNames, commandNames.contains("set-permission"));
        assertTrue("Expected 'update-permission' to be in the command list: " + commandNames, commandNames.contains("update-permission"));
        assertTrue("Expected 'delete-permission' to be in the command list: " + commandNames, commandNames.contains("delete-permission"));
        assertTrue("Expected 'set-user-role' to be in the command list: " + commandNames, commandNames.contains("set-user-role"));
    }
