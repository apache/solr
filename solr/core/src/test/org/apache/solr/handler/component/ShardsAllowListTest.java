...
public class ShardsAllowListTest extends MultiSolrCloudTestCase {
  ...
  /**
   * The cluster with this key will include an explicit list of host allowed (all hosts in both the
   * clusters)
   */
        ...
        new DefaultClusterCreateFunction() {
          ...
          public MiniSolrCloudCluster apply(String clusterId) {
            try {
              ...
              cluster = new MiniSolrCloudCluster.Builder(nodesPerCluster(clusterId), createTempDir())
