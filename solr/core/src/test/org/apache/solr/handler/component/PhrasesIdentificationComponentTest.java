...
public class PhrasesIdentificationComponentTest extends SolrTestCaseJ4 {
  ...
  public void testSimpleSearchRequests() throws Exception {
    ...
    assertQ(
        ...
        "//result/doc/str[@name='id'][.='43']", // and phrases should not be returned since they weren't requested...
    ...
    assertQ(
        ...
        "//result[@numFound='2']",
        "//result/doc/str[@name='id'][.='42']",
        "//result/doc/str[@name='id'][.='43']", // and phrases should not be returned since they were explicitly disabled...
        "0=count(//lst[@name='phrases'])");
