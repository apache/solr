...
public class TestMultiValuedNumericRangeQuery extends SolrTestCase {
  ...
  public void testMultiValuedNRQ() throws Exception {
    ...
    for (int i = 0; i < num; i++) {
      ...
      TopScoreDocCollectorManager trManager = new TopScoreDocCollectorManager(1, Integer.MAX_VALUE);
      TopScoreDocCollector trCollector = trManager.newCollector();
      TopScoreDocCollectorManager nrManager = new TopScoreDocCollectorManager(1, Integer.MAX_VALUE);
      TopScoreDocCollector nrCollector = nrManager.newCollector();
