...
public class DenseVectorFieldTest extends AbstractBadConfigTestBase {
  ...
  public void parseVector_NotAList_shouldThrowException() {
    RuntimeException thrown =
        assertThrows(
            ...
            () -> {
              toTestFloatEncoding
                  .getVectorBuilder("string", DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getFloatVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
    ...
    thrown =
        assertThrows(
            ...
            () -> {
              toTestFloatEncoding
                  .getVectorBuilder(1.5f, DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getFloatVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
    ...
    thrown =
        assertThrows(
            ...
            () -> {
              toTestByteEncoding
                  .getVectorBuilder("1", DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getByteVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
            ...
            () -> {
              toTestFloatEncoding
                  .getVectorBuilder(
                      ...
                      DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getFloatVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
    ...
    RuntimeException thrown =
        assertThrows(
            ...
            () -> {
              toTestFloatEncoding
                  .getVectorBuilder(
                      Arrays.asList(1.0f, 1.5f), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getFloatVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
    ...
    thrown =
        assertThrows(
            ...
            () -> {
              toTestByteEncoding
                  .getVectorBuilder(
                      Arrays.asList(2, 1), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
                  .getByteVector();
            });
    MatcherAssert.assertThat(
        thrown.getMessage(),
  ...
  public void parseVector_StringArrayList_shouldParseFloatArray() {
    ...
    MatcherAssert.assertThat(
        toTestFloatEncoding
            .getVectorBuilder(
                Arrays.asList(1.1f, 2.2f, 3.3f), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
            .getFloatVector(),
        is(expected));
  }
  ...
  public void parseVector_StringArrayList_shouldParseByteArray() {
    ...
    MatcherAssert.assertThat(
        toTestByteEncoding
            .getVectorBuilder(
                Arrays.asList(1, 2, 3), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
            .getByteVector(),
        is(expected));
  }
  ...
  public void parseVector_DoubleArrayList_shouldParseFloatArray() {
    ...
    MatcherAssert.assertThat(
        toTestFloatEncoding
            .getVectorBuilder(
                Arrays.asList(1.7d, 5.4d, 6.6d), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
            .getFloatVector(),
        is(expected));
  }
  ...
  public void parseVector_FloatArrayList_shouldParseFloatArray() {
    ...
    MatcherAssert.assertThat(
        toTestFloatEncoding
            .getVectorBuilder(
                Arrays.asList(5.5f, 7.7f, 9.8f), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
            .getFloatVector(),
        is(expected));
  }
  ...
  public void parseVector_IntArrayList_shouldParseByteArray() {
    ...
    MatcherAssert.assertThat(
        toTestByteEncoding
            .getVectorBuilder(
                Arrays.asList(5, 7, 9), DenseVectorField.VectorBuilder.BuilderPhase.INDEX)
            .getByteVector(),
        is(expected));
  }
