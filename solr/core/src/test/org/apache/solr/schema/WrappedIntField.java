...
public class WrappedIntField extends IntField {
  ...
  private static DoubleValuesSource fromSortField(SortField field) {
    switch (field.getType()) {
      ...
      case FLOAT:
        return DoubleValuesSource.fromField(
            field.getField(), l -> NumericUtils.sortableIntToFloat((int) l));
      case DOUBLE:
        return DoubleValuesSource.fromField(field.getField(), NumericUtils::sortableLongToDouble);
      case SCORE:
