...
public class IndexSchemaTest extends SolrTestCaseJ4 {
  ...
  /**
   * This test assumes the schema includes: &lt;dynamicField name="dynamic_*" type="string"
   * indexed="true" stored="true"/&gt; &lt;dynamicField name="*_dynamic" type="string"
  ...
  public void testProperties() {
    ...
    assertTrue(
        ...
        expectedType.isInstance(tdatedv));
    assertTrue(
        "Expecting a field type defined as " + expectedDefinition,
    ...
    if (tdatedv instanceof TrieDateField trieDateField) {
      assertEquals(
          "Expecting a field type defined as " + expectedDefinition,
          6,
          trieDateField.getPrecisionStep());
    }
  }
