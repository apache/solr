...
public class SSLCredentialProviderFactoryTest extends SolrTestCase {
  ...
  public TestRule syspropRestore =
      new TestRuleRestoreSystemProperties(SSLCredentialProviderFactory.PROVIDER_CHAIN_KEY);
  ...
  public static class CustomSSLCredentialProvider implements SSLCredentialProvider {
    @Override
