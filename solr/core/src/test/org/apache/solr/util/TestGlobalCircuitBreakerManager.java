...
import org.apache.solr.util.circuitbreaker.*;
...
public class TestGlobalCircuitBreakerManager extends SolrTestCaseJ4 {
    ...
    public void testEnableDisable() {
        ...
        GlobalCircuitBreakerConfig.CircuitBreakerConfig loadConfig = new GlobalCircuitBreakerConfig.CircuitBreakerConfig();
    ...
    public void testDisableOne() {
        ...
        loadConfig.enabled = true;
        loadConfig.queryThreshold = 1.0;
        GlobalCircuitBreakerConfig.CircuitBreakerConfig memConfig = new GlobalCircuitBreakerConfig.CircuitBreakerConfig();
    ...
    public void testHostOverride() {
        ...
        GlobalCircuitBreakerConfig.CircuitBreakerConfig overrideLoadConfig = new GlobalCircuitBreakerConfig.CircuitBreakerConfig();
    ...
    public void testHostOverrideInvalidNode() {
        ...
        putHostOverride(globalConfig, "notANode-thatExists", LoadAverageCircuitBreaker.class, overrideLoadConfig);
    ...
    private Map<String, Object> getClusterProperties(GlobalCircuitBreakerConfig config) {
        ...
        ret.put(GlobalCircuitBreakerConfig.CIRCUIT_BREAKER_CLUSTER_PROPS_KEY, config.toMap(new HashMap<>()));
        return ret;
    }
    ...
    private void putHostOverride(GlobalCircuitBreakerConfig globalConfig, String hostname, Class<?> cbClass, GlobalCircuitBreakerConfig.CircuitBreakerConfig cbConfig) {
