...
public class TestGroupingSearch extends SolrTestCaseJ4 {
  ...
  public void testGroupingNoQuery() {
    ...
    assertQ(
        req("group", "true", "group.query", ""), "//lst[2]/lst[@name='']/result[@numFound='0']");
  }
  ...
  public void testGroupingWithTimeAllowed() throws Exception {
    ...
    // TODO: this always throws exception now, regardless of partialResults=true
    // probably needs SOLR-17151 to fix how QueryLimitsExceeded exception is handled
    assertQEx(
        "limit exceeded",
        req(
            "q",
