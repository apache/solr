...
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/dynamicfields?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/fieldtypes?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/copyfields?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/name?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/version?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/uniquekey?wt=json"
----
====
--
...
[source,bash]
----
curl -X GET "http://localhost:8983/api/collections/techproducts/schema/similarity?wt=json"
----
====
--
