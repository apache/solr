...
|field value |{solr-javadocs}/contrib/ltr/org/apache/solr/ltr/feature/FieldValueFeature.html[FieldValueFeature] or {solr-javadocs}/contrib/ltr/org/apache/solr/ltr/feature/PrefetchingFieldValueFeature.html[PrefetchingFieldValueFeature] |`{"field":"hits"}` |not (yet) supported
