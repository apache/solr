...
In this case, you can scale up the capabilities of your application using <<scaling-solr.adoc#,SolrCloud>> to better distribute the data, and the processing of requests, across many servers. Multiple options can be mixed and matched depending on the scalability you need.
