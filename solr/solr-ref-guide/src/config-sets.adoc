...
The default base directory is `$SOLR_HOME/configsets`. This path can be configured in `solr.xml` (see <<configuring-solr-xml.adoc#,Format of solr.xml>> for details).
