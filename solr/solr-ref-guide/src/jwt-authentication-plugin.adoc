...
This is a Solr Contrib package with the name `jwt-auth`. It needs to be added to the main classpah, not the classpath
of a core/collection. This can be done through declaring the contrib jar in `sharedLib`.
See <<Configuring solr.xml>> for details.
