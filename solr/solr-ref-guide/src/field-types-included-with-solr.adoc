...
|DenseVectorField |Supports indexing dense vectors of float values. To be used in combination with <<other-parsers.adoc#ranking-query-parser,RankQParserPlugin>> to implement Neural Search.
