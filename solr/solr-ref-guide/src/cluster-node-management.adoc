...
* `YELLOW` - less than 1/3rd of replicas in a shard is offline, and there's a shard leader
* `ORANGE` - more than 1/3rd but less than 2/3rd of replicas in a shard is offline,
