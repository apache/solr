...
`shards`::
Specifies the shards in your distributed indexing configuration. For more information about distributed indexing, see <<user-managed-distributed-search.adoc#,User-Managed Distributed Search>>.
+
...
+
See the section <<solrcloud-distributed-requests.adoc#configuring-the-shardhandlerfactory,Configuring the ShardHandlerFactory>> for more information about how the whitelist works.
