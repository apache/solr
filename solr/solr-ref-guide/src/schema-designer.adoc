...
The upload feature is useful if you have large or many sample documents; the Schema Designer API allows up to 5,000 sample documents but in most cases you only need a handful of documents to get started.
