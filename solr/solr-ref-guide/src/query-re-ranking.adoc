...
`reRankQuery`::
The query string for your complex ranking query - in most cases <<local-params.adoc#,a variable>> will be used to refer to another request parameter. This parameter is required.
