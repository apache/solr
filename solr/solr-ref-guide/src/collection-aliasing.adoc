...
[source,bash]
----
http://localhost:8983/admin/collections?action=ALIASPROP&name=somename&property.someKey=somevalue
----
====
...
[source,bash]
----
http://localhost:8983/solr/admin/collections?action=DELETEALIAS&name=somename
----
====
