...
[NOTE]
====
The "Cloud" menu option is only available on Solr instances running in <<clusters.adoc#solrcloud-mode,SolrCloud mode>>. Single node or leader/follower replication instances of Solr will not display this option.
====
