...
== fq.qparser (Filter Query Query Parser) Parameter

The default query parser for use with filter queries (`fq` parameter). The default value of this
parameter, for consistency with all previous Solr versions, is `lucene`.
