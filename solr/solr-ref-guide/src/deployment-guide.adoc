...
****
<<scaling-solr.adoc#,*Scaling Solr*>>: Cluster configuration options.
...
****
<<monitoring-solr.adoc#,*Monitoring Solr*>>: Monitoring options for a production Solr instance.
...
****
<<securing-solr.adoc#,*Securing Solr*>>: Authentication and authorization plugins available with Solr. *TODO* format this like the others.
