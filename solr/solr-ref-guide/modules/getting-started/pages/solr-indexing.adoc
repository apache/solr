...
Fields that are not explicitly defined in the Schema will either be ignored or mapped to a xref:indexing-guide:dynamic-fields.adoc[dynamic field definition], if one matching the field name exists.
