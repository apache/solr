...
[[exercise-5]]
== Exercise 5: Indexing and using Vectors in Solr

This exercise will use the Films example that we looked at previously in Excercise 4.


=== Preparing Schemaless for the Vector data
