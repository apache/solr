...
----
$ bin/post -c films example/films/films.json
# bin/java -classpath /solr-{solr-full-version}/server/solr-webapp/webapp/WEB-INF/lib/solr-core-{solr-full-version}.jar -Dauto=yes -Dc=films -Ddata=files org.apache.solr.util.cli.SimplePostTool example/films/films.json
