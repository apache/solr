...
[,console]
----
curl 'http://localhost:8983/solr/buzz/select?fl=text_*,score&q=\{!bool+should=$ref\}&ref=\{!boost+b=10\}\{!rank+f=bumble_rank+function=linear\}&ref=\{!boost+b=2\}\{!rank+f=honey_rank+function=linear\}&ref=\{!rank+f=bee_rank+function=linear\}'
----
...
[,console]
----
curl 'http://localhost:8983/solr/buzz/select?fl=text_*,score&q=\{!bool+should=$ref\}&ref=\{!boost+b=10\}\{!rank+f=lsr_term3+function=linear\}&ref=\{!boost+b=2\}\{!rank+f=lsr_term6+function=linear\}&ref=\{!rank+f=lsr_term2+function=linear\}'
----
