...
On xref:cluster-types.adoc#solrcloud-clusters[SolrCloud] nodes, an additional pulldown list shows all collections in this cluster.
...
[NOTE]
====
The Schema Designer is only available on Solr instances running xref:cluster-types.adoc#solrcloud-clusters[SolrCloud].
====
...
[NOTE]
====
The Collection Selector pull-down menu is only available on Solr instances running xref:cluster-types.adoc#solrcloud-clusters[SolrCloud].

User-managed clusters or standalone installations will not display this menu, instead the Collection specific UI pages described in this section will be available in the <<Core-Specific Tools,Core Selector pull-down menu>>.
====
