...
Entering auto mode. File endings considered are xml,json,jsonl,ndjson,csv,pdf,doc,docx,ppt,pptx,xls,xlsx,odt,odp,ods,ott,otp,ots,rtf,htm,html,txt,log
...
POSTing file more_books.jsonl (application/x-ndjson) to [base]
