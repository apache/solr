...
that participates in the distributed search (although reaching this limit in the query coordinator is unlikely).
Should any one of replicas locally exceed the allowed CPU time the whole distributed search will be terminated
