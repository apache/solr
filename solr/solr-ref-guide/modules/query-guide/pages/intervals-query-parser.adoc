...
The Intervals Query Parser builds Lucene interval queries from a xref:json-request-api.adoc[JSON DSL] description.
...
|===
+
A fallback for the field to run the intervals query against.
