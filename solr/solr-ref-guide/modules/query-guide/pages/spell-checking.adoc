...
<searchComponent name="spellcheck" class="solr.SpellCheckComponent">
  <lst name="spellchecker">
    ...
    <float name="thresholdTokenFrequency">0.3</float>
    <str name="comparatorClass">score</str>
    -->
    <!-- additional elements to configure analysis on query
...
<searchComponent name="spellcheck" class="solr.SpellCheckComponent">
  <lst name="spellchecker">
    ...
    -->
    <!-- additional elements to configure analysis on dictionary and query
