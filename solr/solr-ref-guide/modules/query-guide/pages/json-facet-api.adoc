...
[tabs#json-query-facet-expanded]
======
curl::
+
====
...
[tabs#json-metrics-facet-simple]
======
curl::
+
====
...
[tabs#json-metrics-facet-expanded]
======
curl::
+
====
...
[tabs#json-nested-cat-facet-sorted]
======
curl::
+
====
...
----
curl -sS 'http://localhost:8983/solr/gettingstarted/update?commit=true' -d '[
...
[source,bash,subs="verbatim,callouts"]
----
curl -sS http://localhost:8983/solr/gettingstarted/query -d 'rows=0&q=*:*
&back=*:*                                  # <1>
&fore=age:[35 TO *]                        # <2>
&json.facet={
  hobby : {
