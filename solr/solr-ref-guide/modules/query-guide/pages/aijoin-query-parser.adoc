...
[source,xml]
----
<queryParser name="auxIndexJoin" class="org.apache.solr.search.join.AIJoinQParserPlugin">
...
`auxIndexJoin` is completely experimental. It even might not guarantee compatibility with future versions.
