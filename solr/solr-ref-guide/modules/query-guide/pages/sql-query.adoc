...
Once the jars are available on the classpath, the Solr JDBC driver name is `org.apache.solr.client.solrj.io.sql.DriverImpl` and a connection can be made with the following connection string formats:

==== HTTP-based JDBC URL
[source,plain]
----
jdbc:solr:http://SOLR_HTTP_CONNECTION_STRING?collection=COLLECTION_NAME
----
...
[source,plain]
----
jdbc:solr:http://solr1.example.com:8983/solr?collection=COLLECTION_NAME
----


==== ZooKeeper-based JDBC URL
[source,plain]
----
...
[source,plain]
----
jdbc:solr://zoo.example.com:2181/solr?collection=COLLECTION_NAME
----
