...
This is typically a good fit when you need stored-field compatibility for workflows such as `/get`, reindexing, or atomic updates, but do not routinely return the vector field in latency-sensitive traffic.
