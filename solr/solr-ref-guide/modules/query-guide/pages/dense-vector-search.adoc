...
|===
+
A query that enables the Lucene’s implementation of {lucene-javadocs}/join/org/apache/lucene/search/join/DiversifyingChildrenFloatKnnVectorQuery.html[Diversifying Knn Query] .
+
