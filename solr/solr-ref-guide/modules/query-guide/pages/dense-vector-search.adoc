...
&children.q={!knn f=multivaluedvector topK=3 parents.preFilter=$someParents childrenOf=$allParents}[1.0, 2.0, 3.0, 4.0]
&allParents=*:* -_nest_path_:*
&someParents=color_s:RED
...
All Children
[source,text]
fl=id,multivaluedvector,[child fl="multivaluedvector"]
...
Best Child
[source,text]
fl=id,multivaluedvector,[child fl="multivaluedvector" childFilter=$children.q]
