...
* `m` - m parameter passed to the fallback Lucene99HnswVectorsWriter

* `efConstruction` - efConstruction parameter passed to the fallback Lucene99HnswVectorsWriter
