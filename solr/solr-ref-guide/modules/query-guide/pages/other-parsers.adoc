...
<<Join Query Parser,Join Query Parser>>, but uses a lazily written sidecar index
for faster joins.

Details of this query parser are in the section xref:aijoin-query-parser.adoc[].
