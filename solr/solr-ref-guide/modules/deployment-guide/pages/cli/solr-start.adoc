...
*bin/solr start* [*-fhqVy*] [*--force*] [*--user-managed*] [*--verbose*]
               [*--data-home*=_<dataHome>_] [*-e*=_<example>_]
               [*--example-dir*=_<exampleDir>_] [*--host*=_<host>_] [*-j*=_<jettyParams>_]
               [*--jvm-opts*=_<jvmOpts>_] [*-m*=_<memory>_] [*-p*=_<port>_]
               [*--prompt-inputs*=_<values>_] [*--server-dir*=_<serverDir>_]
               [*--solr-home*=_<solrHome>_] [*-z*=_<zkHost>_]
