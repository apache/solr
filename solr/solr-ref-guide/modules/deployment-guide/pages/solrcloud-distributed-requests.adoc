...
This is in contrast to standalone mode, where the `shards` parameter is required in order to distribute the query.
...
NRT searching is one of the main features of SolrCloud and is rarely attempted in standalone mode.
