...
The `package` command allows you to interact with Solr's xref:configuration-guide:package-manager.adoc#package-manager[Package Manager].
...
Learn more about on the xref:backup-restore.adoc#backup-restore[Backup and Restore] and xref:collection-management.adoc#collection-management[Collection Management] pages.
