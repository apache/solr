...
* Take the base https://github.com/apache/solr/blob/main/solr/core/src/resources/security.json[security.json] file, evolves it using `auth` command parameters, and uploads the new file to ZooKeeper.
+
