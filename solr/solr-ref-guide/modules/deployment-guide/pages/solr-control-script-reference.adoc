...
* Customizes the base `security.json` file for a specific user and uploads it to ZooKeeper.
The base `security.json` file is :
+
[source,java,indent=0]
----
include::/Users/epugh/Documents/projects/solr-epugh/solr/core/src/resources$security.json
----
+
