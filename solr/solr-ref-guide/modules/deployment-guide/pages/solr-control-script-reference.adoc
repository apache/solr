...
and is useful for parallel processing tasks; it can be posted back via the
xref:indexing-guide:indexing-with-update-handlers.adoc#newline-delimited-json[`/update/ndjson`] endpoint. Learn more at https://jsonlines.org/.
