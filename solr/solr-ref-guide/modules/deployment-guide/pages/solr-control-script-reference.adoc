...
+
For example, when using the "cloud" example, you can answer the interactive session's questions non-interactively to start a three node cluster on specific ports:
+
*Example*: `bin/solr start -e cloud --session-inputs 3,9000,9001,9002,"mycollection",2,2,_default`

On Windows please wrap the session-inputs value in double quotes to preserve the comma delimited format.
