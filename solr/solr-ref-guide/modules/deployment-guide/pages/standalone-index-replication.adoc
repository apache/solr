...
Standalone index replication distributes complete copies of a leader index to one or more follower replicas.
...
image::standalone-index-replication/standalone-replication.png[]
...
image::standalone-index-replication/replication.png[image,width=412,height=250]
