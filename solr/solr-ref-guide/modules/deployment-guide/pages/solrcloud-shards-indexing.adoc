...
As well as supporting replication, automatic index splitting to shards, there is support for automatic routing of documents to specific shards by a sharding strategy.
