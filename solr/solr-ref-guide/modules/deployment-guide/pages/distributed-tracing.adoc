...
To use gRPC, you must add the required gRPC, OkHttp, and Protobuf jars to the `opentelemetry` module's lib directory and set `OTEL_EXPORTER_OTLP_PROTOCOL=grpc`.
