...
Additionally, if you can't connect to running Solr from an external location, check your xref:securing-solr.adoc#security-network-binding-1[`SOLR_HOST_BIND` setting] to make sure Solr is accessible to the network.
