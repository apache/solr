...
If you run a standalone installation, you will use the replication handler.
...
For details on configuring the replication handler, see the section xref:standalone-index-replication.adoc#configuring-the-replicationhandler[Configuring the ReplicationHandler].
...
More information about `maxNumberOfBackups` can be found in the section xref:standalone-index-replication.adoc#configuring-the-replicationhandler[Configuring the ReplicationHandler].
