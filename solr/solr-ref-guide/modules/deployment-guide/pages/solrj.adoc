...
- {solr-javadocs}/solrj/org/apache/solr/client/solrj/jetty/Http2SolrClient.html[`HttpJettySolrClient`] - a general purpose client based on Jetty HttpClient.  Supports HTTP/2 and HTTP/1.1, async, non-blocking.  Most used & tested.
