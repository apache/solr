...
- {solr-javadocs}/solrj/org/apache/solr/client/solrj/impl/HttpSolrJdkClient.html[`HttpSolrJdkClient`] - General-purpose client using the JDK's built-in Http Client.  Supports both Http/2 and Http/1.1.  Targeted for those users wishing to minimize application dependencies.
