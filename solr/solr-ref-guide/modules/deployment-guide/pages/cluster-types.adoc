...
Solr's user-managed mode requires that cluster coordination activities that SolrCloud uses ZooKeeper for, will get performed manually or with local scripts.
