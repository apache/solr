...
To enable this feature, users should set the following system property `-Dsolr.solrj.http.customizer=org.apache.solr.client.solrj.jetty.PreemptiveBasicAuthClientCustomizer`.
