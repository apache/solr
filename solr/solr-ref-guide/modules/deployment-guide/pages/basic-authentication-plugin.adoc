...
<3> A user called 'solr', with a password `'SolrRocks'`, in the encoded format detailed above, has been defined. See below for a bash script on how to caculate the encoded format.
...
The following bash script illustrates how to calculated the encoded password format:
