...
----
{
  ...
  "taskList":[
    {
      "taskID":"0",
      "taskQuery":"q=weight_i:[0+TO+200]&canCancel=true&queryUUID=0"},
    {
      "taskID":"5",
      "taskQuery":"q=weight_i:[0+TO+200]&canCancel=true&queryUUID=5"},
    {
      "taskID":"4bcd27bb-0792-4512-a699-532fa7878bd3",
      "taskQuery":"q=weight_i:[0+TO+200]&canCancel=true"}]}
----
====
======
