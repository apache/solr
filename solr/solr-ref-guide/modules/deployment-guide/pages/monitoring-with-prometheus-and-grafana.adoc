...
|===
+
The Solr base URL (such as `\http://localhost:8983/solr`) when Solr is running in a standalone installation.
...
If you are running a standalone installation, do not specify this parameter.
...
Only used with standalone installations.
