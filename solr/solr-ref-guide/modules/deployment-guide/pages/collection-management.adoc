...
[source,bash]
----
curl http://localhost:8983/api/collections -H 'Content-Type: application/json' -d '
  {
...
Use of docValues is highly encouraged on this field.
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts_v2/reload -H 'Content-Type: application/json' -d '
  {
    "async": "someAsyncId"
  }
'
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts_v2 -H 'Content-Type: application/json' -d '
  {
    "modify": {
      "replicationFactor": 2
    }
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts/rename -H 'Content-Type: application/json' -d '
  {
    "to": "newName"
  }
'
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts/backups/techproducts_backup/versions -H 'Content-Type: application/json' -d '
  {
...
+
If a backup with this name already exists, a new backup point is added to it; otherwise a new backup is created.
...
[source,bash]
----
curl http://localhost:8983/api/backups/techproducts_backup/restore -H 'Content-Type: application/json' -d '
  {
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts -H 'Content-Type: application/json' -d '
  {
    "rebalance-leaders": {
      "maxAtOnce": 3
    }
...
[source,bash]
----
curl http://localhost:8983/api/collections/techproducts/snapshots/snapshot0 -H 'Content-Type: application/json' -d '
  {
    "followAliases": true,
    "async": "someAsyncId"
  }
