...
The `solr-precreate` command takes an optional extra argument to specify a configset directory below `/var/solr/data/configsets/` or you can specify a full path to a custom configset inside the container:
