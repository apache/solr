...
[IMPORTANT]
====
Version 10 brought large changes to metrics, with different naming and endpoints. These new metrics are to be considered experimental / BETA. We reserve the right to make breaking changes even in minor releases.
====
