...
|solr.tracing.always.on.header|solr.traceIdHeader|X-Trace-Id|Specifies the HTTP header name used by Solr's built-in non-OTEL tracing to propagate the trace ID between Solr nodes.
