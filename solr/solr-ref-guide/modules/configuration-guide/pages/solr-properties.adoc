...
|solr.cloud.delete.unknown.cores.enabled|solr.deleteUnknownCores|false|Controls deletion of unexpected cores at startup (per ZK state.json) and preexisting core data during core creation in SolrCloud mode.
