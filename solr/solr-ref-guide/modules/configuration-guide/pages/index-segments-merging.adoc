...
<<<<<<< HEAD:solr/solr-ref-guide/modules/configuration-guide/pages/index-segments-merging.adoc
image::segments-info/segments_info.png[image,width=486,height=250]
=======
image::images/index-segments-merging/segments_info.png[image,width=486,height=250]
>>>>>>> main:solr/solr-ref-guide/src/index-segments-merging.adoc
