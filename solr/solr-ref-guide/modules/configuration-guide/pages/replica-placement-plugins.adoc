...
the plugin configured in system property `solr.defaultPlacementPlugin` or environment
variable `SOLR_DEFAULT_PLACEMENT_PLUGIN`. Supported values are `simple`, `random`, `affinity`
