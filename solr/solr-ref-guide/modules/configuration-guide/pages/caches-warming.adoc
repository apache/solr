...
The metrics can be accessed in the xref:deployment-guide:plugins-stats-screen.adoc[] or with the xref:deployment-guidemetrics-reporting.adoc#metrics-api[Metrics API].
