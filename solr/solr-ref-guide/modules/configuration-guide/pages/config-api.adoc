...
[source,bash]
----
curl 'http://localhost:8983/solr/techproducts/config' -H 'Content-type: application/json' -d '{"set-property":{"updateHandler.autoCommit.maxTime":15000}}'
----
====
V2 API::
+
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/techproducts/config' -H 'Content-type: application/json' -d '{"set-property":{"updateHandler.autoCommit.maxTime":15000}}'
----
====
======
...
[source,bash]
----
curl 'http://localhost:8983/solr/techproducts/config' -H 'Content-type: application/json' -d '{"unset-property": "updateHandler.autoCommit.maxTime"}'
----
====
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/techproducts/config' -H 'Content-type: application/json' -d '{"unset-property": "updateHandler.autoCommit.maxTime"}'
----
====
======
...
[source,bash]
----
curl 'http://localhost:8983/solr/techproducts/config' -H 'Content-type:application/json' -d '{"set-user-property": {"variable_name": "some_value"}}'
----
====
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/techproducts/config' -H 'Content-type:application/json' -d '{"set-user-property": {"variable_name": "some_value"}}'
----
====
======
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/techproducts/config' -H 'Content-type:application/json' -d '{"unset-user-property": "variable_name"}'
----
====
======
...
[source,bash]
----
curl 'http://localhost:8983/solr/techproducts/config' -H 'Content-type:application/json' -d '{"add-updateprocessor":
  {"name": "firstFld",
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/techproducts/config' -H 'Content-type:application/json' -d '{"add-updateprocessor":
  {"name": "firstFld",
  "class": "solr.FirstFieldValueUpdateProcessorFactory",
  "fieldName": "test_s"}
}'
