...
Plugins can also be installed by creating `<containerPlugin>` elements in `solr.xml`.
...
[source,xml]
----
<containerPlugin name="my-plugin1" class="my-package:com.example.MyPlugin" />
----
...
[source,xml]
----
<containerPlugin name=".placement-plugin" class="org.apache.solr.cluster.placement.plugins.AffinityPlacementFactory">
