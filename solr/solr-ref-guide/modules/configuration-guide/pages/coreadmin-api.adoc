...
[source,bash]
----
curl -X POST http://localhost:8983/api/cores/_core-name_/rename -H 'Content-Type: application/json' -d '
  {
    "to": "_other-core-name_"
  }
'
----
====
--
=== RENAME V2 API Request Body Parameters
`to`::
+
[%autowidth,frame=none]
|===
