...
[source,bash]
----
curl http://localhost:8983/api/cores -H 'Content-Type: application/json' -d '
  {
...
[source,bash]
----
curl http://localhost:8983/api/cores/currentCoreName/rename -H 'Content-Type: application/json' -d '
  {
    "to": "newCoreName"
  }
'
...
[source,bash]
----
curl http://localhost:8983/api/cores/_core-name_/swap -H 'Content-Type: application/json' -d '
  {
...
[source,bash]
----
curl http://localhost:8983/api/cores/techproducts/unload -H 'Content-Type: application/json' -d '
  {}
'
----
====
...
[source,bash]
----
curl http://localhost:8983/api/cores/targetCoreName/merge-indices -H 'Content-Type: application/json' -d '
{
