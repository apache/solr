...
The system properties `solr.pki.sendVersion` and `solr.pki.acceptVersions` are no longer recognized.
Users upgrading should verify that these properties are not set, before starting the upgrade.
