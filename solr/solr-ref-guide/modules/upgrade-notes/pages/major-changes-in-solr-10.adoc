...
Current permit utilization can be monitored via the `solr_client_request_async_permits` metric (see xref:metrics-reporting.adoc#http-client-registry[HTTP Client Registry]).
