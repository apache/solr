...
* The legacy `CircuiBreakerManager` class has been removed. Please use one or more of the pluggable xref:deployment-guide:circuit-breakers.adoc[Circuit Breaker] implementations instead.