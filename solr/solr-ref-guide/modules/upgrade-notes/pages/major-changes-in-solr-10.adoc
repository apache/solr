...
In addition, the maximum HTTP response header size now defaults to 16 KB (up from 8 KB) and can be tuned with the `solr.jetty.response.header.size.max` system property.
