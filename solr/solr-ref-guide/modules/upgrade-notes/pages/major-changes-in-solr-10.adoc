...
* The deprecated telemetry tags `http.status_code` and `http.method` have been removed from span data. Use `http.response.status_code` and `http.request.method` instead. (SOLR-18110)
