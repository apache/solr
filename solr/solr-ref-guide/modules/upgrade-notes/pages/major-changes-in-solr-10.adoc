...
* The Prometheus exporter has been removed. Users should get prometheus metrics directly from the /admin/metrics endpoint or use OTLP with an external collection tool such as the Open Telemetry Collector.