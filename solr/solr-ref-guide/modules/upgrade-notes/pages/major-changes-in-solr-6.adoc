...
A new xref:query-guide:other-parsers.adoc#graph-query-parser[`graph` query parser] makes it possible to graph traversal queries of Directed (Cyclic) Graphs modelled using Solr documents.
