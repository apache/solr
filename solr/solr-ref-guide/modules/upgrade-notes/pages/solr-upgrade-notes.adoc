= Solr Upgrade Notes
:page-children: major-changes-in-solr-11, \
...
your system and review the {solr-javadocs}/changes/Changes.html[`CHANGELOG.md`]
...
Users upgrading from versions prior to 8.x are strongly encouraged to consult {solr-javadocs}/changes/Changes.html[`CHANGELOG.md`] for the details of _all_ changes since the version they are upgrading from.
