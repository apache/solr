...
=== Deprecations
* `rid` support has been deprecated in favor of the always-on trace generation.
To disable the `rid` generation completely set the system property `solr.disableRequestId` to `true`. 
