...
Comparing your configuration to the updated configuration examples in xref:deployment-guide:standalone-index-replication.adoc[] will show examples of what needs to change, but here are the main changes:
+
