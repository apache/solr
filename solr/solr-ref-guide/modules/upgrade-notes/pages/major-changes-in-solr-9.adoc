...
* Changed codec for DenseVectorField to Lucene91HnswVectorsFormat. This codec is not back-compatible with the precedent one. It is necessary to reindex for using Dense Vector Search in Solr 9.1
