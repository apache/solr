...
`application/jsonl` and `application/x-jsonlines` are accepted as aliases for `application/x-ndjson`.
The xref:post-tool.adoc[] sends `.jsonl` and `.ndjson` files in this format automatically.
