...
[source,bash]
----
curl 'http://localhost:8983/solr/my_collection/update/json/docs' -H 'Content-Type: application/json' --data-binary '
{
  "id": "1",
  "title": "Doc 1"
}'
...
[source,bash]
----
curl 'http://localhost:8983/solr/my_collection/update' -H 'Content-Type: application/json' --data-binary '
[
  {
    "id": "1",
    "title": "Doc 1"
