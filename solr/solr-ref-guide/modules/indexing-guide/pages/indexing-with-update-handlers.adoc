...
[source,bash]
----
curl 'http://localhost:8983/solr/my_collection/update?commit=true' -H 'Content-type:application/csv' --data-binary @example/exampledocs/books.csv
----
====
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/my_collection/update?commit=true' -H 'Content-type:application/csv' --data-binary @example/exampledocs/books.csv
----
====
======
...
[source,bash]
----
curl 'http://localhost:8983/api/collections/my_collection/update/csv?commit=true&separator=%09&escape=%5c' --data-binary @/tmp/result.txt
----
====
======
