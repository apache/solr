...
See https://tika.apache.org/docs/4.0.x/using-tika/index.html for the file types supported.
...
See https://tika.apache.org/docs/4.0.x/using-tika/server/index.html for details on Tika Server's output formats; the structure of the XHTML varies with the format being parsed.
