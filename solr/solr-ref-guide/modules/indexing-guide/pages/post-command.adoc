= Solr CLI Post Command
:page-aliases: post-tool.adoc
...
== Using the bin/solr post Command
...
NOTE: This requires a Tika Server to be configured. See xref:indexing-with-tika.adoc#tika-server[Indexing With Tika] for details.
