...
[source,bash]
----
curl -XPUT 'http://localhost:8983/solr/YOUR_COLLECTION/schema/field-generation-model-store' --data-binary "@/path/myModel.json" -H 'Content-type:application/json'
----
...
[source,bash]
----
curl -XDELETE 'http://localhost:8983/solr/YOUR_COLLECTION/schema/field-generation-model-store/currentModel'
----

To view all models:

[source,text]
http://localhost:8983/solr/YOUR_COLLECTION/schema/field-generation-model-store
