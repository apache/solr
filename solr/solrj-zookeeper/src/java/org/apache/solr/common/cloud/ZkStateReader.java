...
public class ZkStateReader implements SolrCloseable {
  ...
  private CollectionPropertiesZkStateReader collectionPropsZkReader;
  ...
  public ZkStateReader(SolrZkClient zkClient, Runnable securityNodeListener) {
    ...
    collectionPropsZkReader = new CollectionPropertiesZkStateReader(this.zkClient);
  ...
  public synchronized void createClusterStateWatchersAndUpdate()
    ...
    try {
      ...
      collectionPropsZkReader.refreshCollectionProperties();
  ...
  public Map<String, String> getCollectionProperties(final String collection) {
    return collectionPropsZkReader.getCollectionProperties(collection, 0);
  }
  ...
  public Map<String, String> getCollectionProperties(final String collection, long cacheForMillis) {
    return collectionPropsZkReader.getCollectionProperties(collection, cacheForMillis);
  }
  ...
  public void registerCollectionPropsWatcher(
    ...
    collectionPropsZkReader.registerCollectionPropsWatcher(collection, propsWatcher);
  }

  public void removeCollectionPropsWatcher(String collection, CollectionPropsWatcher watcher) {
    collectionPropsZkReader.removeCollectionPropsWatcher(collection, watcher);
  }
