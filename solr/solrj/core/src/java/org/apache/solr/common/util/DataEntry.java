...
public interface DataEntry {
  ...
  /**
   * This is the object shared in the parent container in the {{@link #listenContainer(Object,
   * EntryListener)}} method
   */
  Object ctx();
   ...
   *
   * <p>if it's a {{@link CharSequence}} or byte[] , it's the no:of bytes in the stream
   *
