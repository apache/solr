...
public class DomainMapTest extends SolrTestCaseJ4 {
  ...
  public void testStoresFilterWithCorrectKey() {
    final DomainMap domain = new DomainMap().withFilter("name:Solr");
  ...
  public void testStoresMultipleFilters() {
    final DomainMap domain = new DomainMap().withFilter("name:Solr").withFilter("cat:search");
    @SuppressWarnings({"unchecked"})
    final List<String> filterList = (List<String>) domain.get("filter");

    assertTrue(
        "Expected filter list to contain 1st provided filter", filterList.contains("name:Solr"));
    assertTrue(
        "Expected filter list to contain 2nd provided filter", filterList.contains("cat:search"));
  }
  ...
  public void testStoresQueryWithCorrectKey() {
    final DomainMap domain = new DomainMap().withQuery("name:Solr");
    @SuppressWarnings({"unchecked"})
  ...
  public void testStoresMultipleQueries() {
    final DomainMap domain = new DomainMap().withQuery("name:Solr").withQuery("cat:search");
    @SuppressWarnings({"unchecked"})
    final List<String> queryList = (List<String>) domain.get("query");

    assertTrue(
        "Expected query list to contain 1st provided query", queryList.contains("name:Solr"));
    assertTrue(
        "Expected query list to contain 2nd provided query", queryList.contains("cat:search"));
  }
  ...
  public void testStoresTagsToExcludeWithCorrectKey() {
    final DomainMap domain = new DomainMap().withTagsToExclude("BRAND");
    @SuppressWarnings({"unchecked"})
    final List<String> exclusionList = (List<String>) domain.get("excludeTags");

    assertTrue(
        "Expected tag-exclusion list to contain provided tag", exclusionList.contains("BRAND"));
  }

  @Test
  public void testStoresMultipleTagExclusionStrings() {
    final DomainMap domain = new DomainMap().withTagsToExclude("BRAND").withTagsToExclude("COLOR");
    @SuppressWarnings({"unchecked"})
    final List<String> exclusionList = (List<String>) domain.get("excludeTags");

    assertTrue(
        "Expected tag-exclusion list to contain provided 1st tag", exclusionList.contains("BRAND"));
    assertTrue(
        "Expected tag-exclusion list to contain provided 2nd tag", exclusionList.contains("COLOR"));
  }
  ...
  public void testStoresBlockParentQueryWithCorrectKey() {
    final DomainMap domain = new DomainMap().setBlockParentQuery("content_type:product");
  ...
  public void testStoresBlockChildrenQueryWithCorrectKey() {
    final DomainMap domain = new DomainMap().setBlockChildQuery("content_type:productColors");
  ...
  public void testStoresJoinValuesWithCorrectKey() {
    final DomainMap domain =
        new DomainMap().setJoinTransformation("any-from-field", "any-to-field");
