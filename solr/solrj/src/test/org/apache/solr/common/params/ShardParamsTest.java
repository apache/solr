...
/**
 * This class tests backwards compatibility of {@link ShardParams} parameter constants. If someone
...
public class ShardParamsTest extends SolrTestCase {
  public void testShards() {
    assertEquals(ShardParams.SHARDS, "shards");
  }

  public void testShardsRows() {
    assertEquals(ShardParams.SHARDS_ROWS, "shards.rows");
  }

  public void testShardsStart() {
    assertEquals(ShardParams.SHARDS_START, "shards.start");
  }

  public void testIds() {
    assertEquals(ShardParams.IDS, "ids");
  }
  ...
  public void testShardsInfo() {
    assertEquals(ShardParams.SHARDS_INFO, "shards.info");
  }

  public void testShardsTolerant() {
    assertEquals(ShardParams.SHARDS_TOLERANT, "shards.tolerant");
  }
  ...
  public void testShardsPurpose() {
    assertEquals(ShardParams.SHARDS_PURPOSE, "shards.purpose");
  }

  public void testRoute() {
    assertEquals(ShardParams._ROUTE_, "_route_");
  }

  public void testDistribSinglePass() {
    assertEquals(ShardParams.DISTRIB_SINGLE_PASS, "distrib.singlePass");
  }
  ...
  public void testGetShardsTolerantAsBool() {
    ...
    Exception exception =
        expectThrows(
            SolrException.class, () -> HttpShardHandler.getShardsTolerantAsBool(paramsSupplier));
    assertTrue(
