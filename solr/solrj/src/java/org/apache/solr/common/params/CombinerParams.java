...
public class CombinerParams {
  ...
  public static final String COMBINER_METHOD = COMBINER + ".method";
  ...
  public static final String COMBINER_METHOD_PRE = "pre";
  public static final String COMBINER_METHOD_POST = "post";

  public static boolean isPreCombinerMethod(SolrParams solrParams) {
    return solrParams.get(CombinerParams.COMBINER_METHOD) != null
        && CombinerParams.COMBINER_METHOD_PRE.equalsIgnoreCase(
            solrParams.get(CombinerParams.COMBINER_METHOD));
  }
}
