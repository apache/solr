 ...
 */
public class SolrDirectBufferOutputStream extends OutputStream
{
     ...
     * Default constructor.
     */
    public SolrDirectBufferOutputStream()
    {
    }
     ...
     */
    public SolrDirectBufferOutputStream(final MutableDirectBuffer buffer)
    {
     ...
     */
    public SolrDirectBufferOutputStream(final MutableDirectBuffer buffer, final int offset, final int length)
    {
