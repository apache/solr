...
public class TimeTracker {
  ...
  public static final Map<String,TimeTracker> CLOSE_TIMES = new ConcurrentHashMap<>(64);
  ...
  public boolean doneClose(String label) {
    ...
    this.label.insert(0, spacer + extra);
  ...
  public String getCloseTimes() {
    ...
    //      }
    //    } else {
    sb.append(label).append(" ").append(getElapsedMS()).append("ms");
    //    }
    // sb.append("[\n");
  ...
  private static long getElapsedNS(long startTime, long doneTime) {
