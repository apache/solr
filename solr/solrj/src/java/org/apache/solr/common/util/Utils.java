...
public class Utils {
  ...
  private static Object makeDeepCopy(Object v, int maxDepth, boolean mutable, boolean sorted) {
    if (v instanceof MapWriter && maxDepth > 1) {
      v = ((MapWriter) v).toMap(new LinkedHashMap<>(32));
...
//      buffer.limit(outStream.position() + outStream.buffer().wrapAdjustment());
  ...
  private static class MapWriterJSONWriter extends JSONWriter {
    ...
    public void handleUnknownClass(Object o) {
      if (o instanceof MapWriter) {
        Map m = ((MapWriter) o).toMap(new LinkedHashMap<>(32));
        write(m);
      } else {
  ...
  public static byte[] toJSON(Object o, int indent) {
    ...
    if (!(o instanceof List) && !(o instanceof Map)) {
      if (o instanceof MapWriter) {
        o = ((MapWriter) o).toMap(new LinkedHashMap<>(32));
  ...
  // nocommit MRM TODO Object2ObjectMap
      ...
      private static boolean isMapLike (Object o){
        return o instanceof Map || o instanceof MapWriter;
      }
  ...
  public interface InputStreamConsumer<T> {
      ...
      public static <T > T executeGET(Http2SolrClient client, String url, InputStreamConsumer < T > consumer) throws SolrException {
        ...
        Http2SolrClient.SimpleResponse resp;
        try {
  ...
  private static class MySpecProvider implements SpecProvider {
    ...
    private final ValidatingJsonMap validatingJsonMap = new ValidatingJsonMap(null);
