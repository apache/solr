...
public class ReplaceOperation implements StreamOperation {
  ...
  public ReplaceOperation(String forField, StreamExpression expression, StreamFactory factory) throws IOException {
    ...
    StreamExpressionNamedParameter withValue = StreamFactory.getNamedOperand(expression, "withValue");
    StreamExpressionNamedParameter withField = StreamFactory.getNamedOperand(expression, "withField");
