...
public abstract class BiJoinStream extends JoinStream implements Expressible {
  ...
  // order). It is built from the incoming equalitor and streams' comparators.
  ...
  private void init() throws IOException {
    ...
    // the equalitor.
    // Because we've already validated tuple order (the comps) then we know this can be done.
