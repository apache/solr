...
public class AbstractDigestZkACLAndCredentialsProvidersTestBase extends SolrTestCaseJ4 {
        ...
        new ArrayList<>() {
          {
            ...
            add(
                new TestZkCredentialsInjector(
                    SecretCredentialInjector.class,
                    Arrays.asList(
                        SECRET_CREDENTIAL_PROVIDER_CLASS_VM_PARAM,
                        SECRET_CREDENTIAL_PROVIDER_SECRET_NAME_VM_PARAM),
                    Arrays.asList(
                        NoCredentialSecretCredentialsProvider.class.getName(), SECRET_NAME)));
          }
        };
            ...
            add(
                new TestZkCredentialsInjector(
                    ...
                    Arrays.asList(
                        ...
                        SECRET_CREDENTIAL_PROVIDER_SECRET_NAME_VM_PARAM),
                    Arrays.asList(
                        WrongAllCredentialSecretCredentialsProvider.class.getName(), SECRET_NAME)));
          }
        };
            ...
            add(
                new TestZkCredentialsInjector(
                    ...
                    Arrays.asList(
                        ...
                        SECRET_CREDENTIAL_PROVIDER_SECRET_NAME_VM_PARAM),
                    Arrays.asList(
                        AllAndReadonlySecretCredentialsProvider.class.getName(), SECRET_NAME)));
          }
        };
            ...
            add(
                new TestZkCredentialsInjector(
                    ...
                    Arrays.asList(
                        ...
                        SECRET_CREDENTIAL_PROVIDER_SECRET_NAME_VM_PARAM),
                    Arrays.asList(
                        ConnectWithReadonlySecretCredentialsProvider.class.getName(),
                        SECRET_NAME)));
          }
        };
    testInjectors(
  ...
  public static class NoCredentialSecretCredentialsProvider implements SecretCredentialsProvider {
    @Override
    public List<ZkCredential> getZkCredentials(String secretName) {
      return new NoCredentialZkCredentialsInjector().getZkCredentials();
    }
  }

  public static class AllAndReadonlySecretCredentialsProvider implements SecretCredentialsProvider {
    @Override
    public List<ZkCredential> getZkCredentials(String secretName) {
      return new AllCredentialZkCredentialsInjector().getZkCredentials();
    }
  }

  public static class ConnectWithReadonlySecretCredentialsProvider
      implements SecretCredentialsProvider {
    @Override
    public List<ZkCredential> getZkCredentials(String secretName) {
      return new ConnectWithReadonlyCredsInjector().getZkCredentials();
    }
  }

  public static class WrongAllCredentialSecretCredentialsProvider
      implements SecretCredentialsProvider {
    @Override
    public List<ZkCredential> getZkCredentials(String secretName) {
      return new WrongAllCredentialZkCredentialsInjector().getZkCredentials();
    }
  }
