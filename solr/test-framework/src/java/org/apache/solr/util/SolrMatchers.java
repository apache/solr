...
public class SolrMatchers {
  ...
  public static <T> Matcher<List<? extends T>> subListMatches(
      int fromIndex, int toIndex, Matcher<? super Iterable<? extends T>> subListMatcher) {
  ...
  public static class SubListMatcher<T> extends TypeSafeDiagnosingMatcher<List<? extends T>> {
    ...
    private final Matcher<? super Iterable<? extends T>> matchOnSubList;

    public SubListMatcher(
        int fromIndex, int toIndex, Matcher<? super Iterable<? extends T>> matchOnSubList) {
      super();
