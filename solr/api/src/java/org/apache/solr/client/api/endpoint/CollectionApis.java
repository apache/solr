...
public interface CollectionApis {
  ...
  interface Modify {
    @PUT
    @Operation(
        summary = "Modify an existing SolrCloud collection.",
        tags = {"collections"})
    SubResponseAccumulatingJerseyResponse modifyCollection(
        @PathParam("collectionName") String collectionName, ModifyCollectionRequestBody requestBody)
        throws Exception;
  }
