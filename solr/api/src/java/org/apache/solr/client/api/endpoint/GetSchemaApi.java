...
public interface GetSchemaApi {
    ...
    @Operation(
            ...
            parameters = {@Parameter(name = INDEX_TYPE_PATH_PARAMETER, in = ParameterIn.PATH, schema = @Schema(implementation = IndexType.class, enumAsRef = true)), @Parameter(name= INDEX_NAME_PATH_PARAMETER, in = ParameterIn.PATH)},
            tags = {"schema"})
