...
public class S3IndexInputTest extends SolrTestCaseJ4 {
    ...
    /**
     * Simulates fetching a file from S3 in more than one read operation, reading larger than internal buffer size.
     */
    @Test
    ...
    private void doTestPartialRead(boolean directBuffer, String content, int slice) throws IOException {
