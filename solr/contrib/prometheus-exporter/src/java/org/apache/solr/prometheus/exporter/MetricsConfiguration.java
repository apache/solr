...
public class MetricsConfiguration {
  ...
  static {
    try {
      ...
      // Only FEATURE_SECURE_PROCESSING is supported by the JDK's XPathFactory.
      // The DTD/doctype/external-entity protections are Xerces-specific feature URIs
      // that are not valid on XPathFactory; they are applied to the DocumentBuilderFactory
      // (which actually parses the XML) in from(String) instead.
