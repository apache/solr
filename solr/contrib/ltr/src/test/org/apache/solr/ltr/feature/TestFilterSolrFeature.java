...
public class TestFilterSolrFeature extends TestRerankBase {
  ...
  public void before() throws Exception {
    ...
    restTestHarness.update(adoc("id", "3", "title", "w1", "description", "w1", "popularity",
        "3"));
    restTestHarness.update(adoc("id", "4", "title", "w1", "description", "w1", "popularity",
        "4"));
    restTestHarness.update(adoc("id", "5", "title", "w5", "description", "w5", "popularity",
        "5"));
    restTestHarness.update(adoc("id", "6", "title", "w6 w2", "description", "w1 w2",
        "popularity", "6"));
