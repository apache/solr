...
public class TestLTRQParserExplain extends TestRerankBase {
  ...
  public void multipleAdditiveTreesScoreExplainMissingEfiFeatureShouldReturnDefaultScore() throws Exception {
    ...
    final String tree1 = "(weight=1.0,root=(feature=user_device_smartphone,threshold=0.5,missing=right,left=0.0,right=50.0))";
    final String tree2 = "(weight=1.0,root=(feature=user_device_tablet,threshold=0.5,missing=left,left=0.0,right=65.0))";
    ...
    assertJQ(
        "/query" + query.toQueryString(),
        "/debug/explain/7=='\n" +
            "115.0 = MultipleAdditiveTreesModel(name=external_model_binary_feature,trees="+trees+") model applied to features, sum of:\n" +
