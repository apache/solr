...
@Preview
@Composable
fun PreviewConfigsetsContentEmptyConfigsets() = PreviewContainer {
    ConfigsetsContent(component = SimplePreviewConfigsetsComponent())
}

@Preview
@Composable
fun PreviewConfigsetsContentWithConfigsetSelected() = PreviewContainer {
...
@Preview
@Composable
fun PreviewConfigsetsContentWithMenuExpanded() = PreviewContainer {
    val configset = "techproducts"
    ConfigsetsContent(
        component = SimplePreviewConfigsetsComponent(
            model = Model(
