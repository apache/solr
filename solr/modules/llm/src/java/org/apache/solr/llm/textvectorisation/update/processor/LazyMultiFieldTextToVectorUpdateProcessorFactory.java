...
public class LazyMultiFieldTextToVectorUpdateProcessorFactory
    extends TextToVectorUpdateProcessorFactory {
  private static final String INPUT_FIELD_PARAM = "inputField";
  private static final String ADDITIONAL_INPUT_FIELDS_PARAM = "additionalInputFields";
  private static final String OUTPUT_FIELD_PARAM = "outputField";
  private static final String MODEL_NAME = "model";

  protected String[] additionalInputFields;
