...
public class TextEmbedderQParserTest extends TestLlmBase {
    ...
    @Test
    public void embeddedQueryUsedInFilter_shouldFilterResultsBeforeTheQueryExecution() throws Exception {
    ...
    @Test
    public void embeddedQueryUsedInFilters_shouldFilterResultsBeforeTheQueryExecution() throws Exception {
        final String solrQuery = "{!embed model=dummy-1 f=vector topK=4}hello world";
        final SolrQuery query = new SolrQuery();
        query.setQuery("id:(3 4 9 2)");
    ...
    @Test
    public void embeddedQueryUsedInFiltersWithPreFilter_shouldFilterResultsBeforeTheQueryExecution() throws Exception {
        final String solrQuery = "{!embed model=dummy-1 f=vector topK=4 preFilter='id:(1 4 7 8 9)'}hello world";
        final SolrQuery query = new SolrQuery();
        query.setQuery("id:(3 4 9 2)");
        query.setFilterQueries(solrQuery, "id:(4 20 9)");
        query.add("fl", "id");
    ...
    public void embeddedQueryAsSubQuery_withPreFilter() throws Exception {
        final String solrQuery = "*:* AND {!embed model=dummy-1 f=vector topK=5 preFilter='id:(2 4 7 9 8 20 3)' v='hello world'}";
        final SolrQuery query = new SolrQuery();
        query.setQuery(solrQuery);
        query.add("fl", "id");
    ...
    @Test
    public void embeddedQueryWithFilterQueries_shouldPerformKnnSearchWithPreFiltersAndPostFilters() throws Exception {
        final String solrQuery = "{!embed model=dummy-1 f=vector topK=4}hello world";
        final SolrQuery query = new SolrQuery();
        query.setQuery(solrQuery);
    ...
    @Test
    public void embeddedQueryWithNegativeFilterQuery_shouldPerformKnnSearchInPreFilteredResults() throws Exception {
        final String solrQuery = "{!embed model=dummy-1 f=vector topK=4}hello world";
        final SolrQuery query = new SolrQuery();
        query.setQuery(solrQuery);
