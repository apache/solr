...
public class KafkaRequestMirroringHandlerTest {
  ...
  @Mock private KafkaMirroringSink kafkaMirroringSink;
  ...
  public void testCheckDeadLetterQueueMessageExecution() throws MirroringException {
    ...
    final KafkaRequestMirroringHandler kafkaRequestMirroringHandler =
        new KafkaRequestMirroringHandler(kafkaMirroringSink);
