...
public class TestFieldGenerationModelManagerPersistence extends TestLanguageModelBase {
  ...
  public void testModelAreStoredCompact() throws Exception {
    ...
    final String JSONOnDisk = Files.readString(fieldGenerationModelStoreFile, StandardCharsets.UTF_8);
