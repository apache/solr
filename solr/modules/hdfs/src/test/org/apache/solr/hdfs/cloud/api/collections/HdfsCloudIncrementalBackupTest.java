...
public class HdfsCloudIncrementalBackupTest extends AbstractIncrementalBackupTest {
  public static final String SOLR_XML =
      "<solr>\n"
          ...
          + "    </repository>\n"
          + "    <repository  name=\"hdfs\" class=\"org.apache.solr.hdfs.backup.repository.HdfsBackupRepository\"> \n"
  ...
  public static void setupClass() throws Exception {
    ...
    try {
      ...
      if (fs instanceof DistributedFileSystem) {
        ...
        while (((DistributedFileSystem) fs)
            .setSafeMode(HdfsConstants.SafeModeAction.SAFEMODE_GET, true)) {
          try {
            Thread.sleep(5000);
