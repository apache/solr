...
Fire up your cluster, say via `bin/solr start -e cloud` and then as you make changes
to assets in `/solr/webapp/web`, run `gradle dev`.   Then do a hard refresh in the
browser to pick up your changes.
