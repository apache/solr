...
Per-core APIs, as the name suggests, typically affect only a single collection or core, usually used to search or analyze that core's contents in some way.
