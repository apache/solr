...
| `other`
| For anything else, like large/significant refactorings, build changes, test infrastructure, or documentation. Most such changes are too small/minor to bother with a changelog entry.
