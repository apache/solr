...
| Adding a new API endpoint, a new query shortcut, or a new optional configuration parameter.
...
| security
| For vulnerabilities, security patches, or hardening improvements.
| Fixing a dependency vulnerability, adding encryption, or tightening access controls.
|===
